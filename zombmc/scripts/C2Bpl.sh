...
do
    smack $DIR/spectre-pht.c $SMACKFLAGS --clang-options="-Dzombmc -D"$version" -fms-extensions -I../../include/" -bpl $DIR/bpl/spectre-pht-$version.o0.bpl
    smack $DIR/spectre-pht.c $SMACKFLAGS --clang-options="-Dzombmc -O2 -D"$version" -fms-extensions -I../../include/" -bpl $DIR/bpl/spectre-pht-$version.o2.bpl
done
