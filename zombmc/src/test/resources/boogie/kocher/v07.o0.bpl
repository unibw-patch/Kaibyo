...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv07 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v07.o0.bpl
...
axiom (victim_function_v07.last_x == $sub.ref(0, 7312));
const {:count 16} .str.1.2: ref;
axiom (.str.1.2 == $sub.ref(0, 8352));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 9384));
const {:count 3} .str.1.7: ref;
axiom (.str.1.7 == $sub.ref(0, 10411));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 11449));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 12477));
const victim_function_v07: ref;
axiom (victim_function_v07 == $sub.ref(0, 13509));
procedure  victim_function_v07($i0: bv64)
{
  var $i1: bv64;
  var $i2: bv1;
  var $p3: ref;
...
$bb0:
  ...
  call {:cexpr "victim_function_v07:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 111, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv64($M.0, victim_function_v07.last_x);
...
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 26} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 26} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 19} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i5), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 19} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $i13 := $load.bytes.bv32($M.0, array1_size);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 113, 14} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv64($M.0, victim_function_v07.last_x, $i0);
  call {:cexpr "victim_function_v07.last_x"} boogie_si_record_bv64($i0);
...
$bb0:
  ...
  $M.0 := $store.bytes.bv64($M.0, victim_function_v07.last_x, 0bv64);
  call {:cexpr "victim_function_v07.last_x"} boogie_si_record_bv64(0bv64);
