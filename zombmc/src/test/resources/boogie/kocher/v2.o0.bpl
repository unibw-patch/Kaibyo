...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv2 -fms-extensions -I../../include/ -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/v2.o0.bpl
...
axiom (leakByteLocalFunction == $sub.ref(0, 11403));
procedure  leakByteLocalFunction($i0: bv8)
{
  ...
  var $i8: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 40, 49} true;
  ...
  assume {:verifier.code 0} true;
  $i4 := $zext.bv8.bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 40, 46} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 40, 68} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const victim_function_v2: ref;
axiom (victim_function_v2 == $sub.ref(0, 12435));
procedure  victim_function_v2($i0: bv64)
{
  ...
  var $i5: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 42, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 42, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 42, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 43, 33} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 43, 33} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bytes.bv8($M.0, $p4);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 43, 11} true;
  assume {:verifier.code 0} true;
  call leakByteLocalFunction($i5);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 44, 6} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 42, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 45, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 251, 5} true;
  assume {:verifier.code 0} true;
