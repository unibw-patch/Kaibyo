...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-O2 -Dv05 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v05.o2.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 50661));
...
axiom (llvm.dbg.value == $sub.ref(0, 12477));
...
$bb6:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 84, 31} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($bv2int.64($i10), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 84, 31} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 84, 24} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i15), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 84, 24} true;
  assume {:verifier.code 0} true;
...
axiom (__SMACK_static_init == $sub.ref(0, 50661));
