...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv12 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v12.o0.bpl
...
axiom (victim_function_v12 == $sub.ref(0, 12477));
...
$bb1:
  assume ($i5 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 35} true;
  assume {:verifier.code 0} true;
  $i6 := $add.bv64($i0, $i1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 26} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($bv2int.64($i6), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 26} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 19} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i9), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 19} true;
  assume {:verifier.code 0} true;
