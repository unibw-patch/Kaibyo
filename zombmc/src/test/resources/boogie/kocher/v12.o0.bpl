...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv12 -fms-extensions -I../../include/ -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/v12.o0.bpl
...
axiom (victim_function_v12 == $sub.ref(0, 11403));
procedure  victim_function_v12($i0: bv64, $i1: bv64)
{
  ...
  var $i16: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 187, 13} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $add.bv64($i0, $i1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 187, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $load.bv32($M.0, publicarray_size);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 187, 20} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.bv32.bv64($i3);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 187, 18} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.bv64($i2, $i4);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 187, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i5 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 46} true;
  assume {:verifier.code 0} true;
  $i6 := $add.bv64($i0, $i1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 32} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i6), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 32} true;
  assume {:verifier.code 0} true;
  $i8 := $load.bytes.bv8($M.0, $p7);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.bv8.bv64($i8);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 187, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 189, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 281, 5} true;
  assume {:verifier.code 0} true;
