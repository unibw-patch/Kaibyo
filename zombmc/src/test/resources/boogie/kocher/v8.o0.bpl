...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv8 -fms-extensions -I../../include/ -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/v8.o0.bpl
...
axiom (victim_function_v8 == $sub.ref(0, 11403));
procedure  victim_function_v8($i0: bv64)
{
  ...
  var $i15: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 43} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 41} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 39} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 65} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 39} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 27} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i5), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 27} true;
  assume {:verifier.code 0} true;
  $i7 := $load.bytes.bv8($M.0, $p6);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 14} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.bv8.bv64($i7);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 124, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 269, 5} true;
  assume {:verifier.code 0} true;
