...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv14 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v14.o0.bpl
...
axiom (victim_function_v14 == $sub.ref(0, 12477));
...
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 218, 35} true;
  assume {:verifier.code 0} true;
  $i4 := $xor.bv64($i0, 255bv64);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 218, 26} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($bv2int.64($i4), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 218, 26} true;
  assume {:verifier.code 0} true;
