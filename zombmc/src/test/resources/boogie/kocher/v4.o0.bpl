...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv4 -fms-extensions -I../../include/ -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/v4.o0.bpl
...
axiom (victim_function_v4 == $sub.ref(0, 11403));
procedure  victim_function_v4($i0: bv64)
{
  ...
  var $i14: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 69, 14} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 69, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 69, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 70, 46} true;
  assume {:verifier.code 0} true;
  $i4 := $shl.bv64($i0, 1bv64);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 70, 32} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i4), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 70, 32} true;
  assume {:verifier.code 0} true;
  $i6 := $load.bytes.bv8($M.0, $p5);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 70, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.bv8.bv64($i6);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 70, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 70, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 70, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 69, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 71, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 257, 5} true;
  assume {:verifier.code 0} true;
