...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv15 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v15.o0.bpl
...
axiom (victim_function_v15 == $sub.ref(0, 12477));
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i2 := $load.bytes.bv32($M.0, array1_size);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 229, 15} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 230, 33} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bytes.bv64($M.0, $p0);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 230, 26} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($bv2int.64($i5), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 230, 26} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 230, 19} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i8), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 230, 19} true;
  assume {:verifier.code 0} true;
...
axiom (llvm.dbg.declare == $sub.ref(0, 13509));
