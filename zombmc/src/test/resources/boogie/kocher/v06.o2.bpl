...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-O2 -Dv06 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v06.o2.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 51689));
...
axiom (llvm.dbg.value == $sub.ref(0, 13505));
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 99, 26} true;
  assume {:verifier.code 0} true;
...
axiom (__SMACK_static_init == $sub.ref(0, 51689));
