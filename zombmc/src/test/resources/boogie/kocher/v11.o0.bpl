...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv11 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v11.o0.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 52725));
...
const spectre_secret: ref;
axiom (spectre_secret == $sub.ref(0, 3100));
const .str: ref;
axiom (.str == $sub.ref(0, 4167));
const temp: ref;
axiom (temp == $sub.ref(0, 5192));
const {:count 64} array2: ref;
axiom (array2 == $sub.ref(0, 6280));
const {:count 16} .str.1.2: ref;
axiom (.str.1.2 == $sub.ref(0, 7320));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 8352));
const {:count 3} .str.1.7: ref;
axiom (.str.1.7 == $sub.ref(0, 9379));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 10417));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 11445));
const mymemcmp: ref;
axiom (mymemcmp == $sub.ref(0, 12477));
...
axiom (victim_function_v11 == $sub.ref(0, 13509));
...
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 44} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 44} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bytes.bv8($M.0, $p4);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 43} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.bv8.bv32($i5);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 41} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.bv32.bv64($i6);
  $p8 := $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i7), 1));
...
axiom (__VERIFIER_assume == $sub.ref(0, 15573));
...
axiom (__SMACK_code == $sub.ref(0, 16605));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 17637));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18669));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 19701));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 20733));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 21765));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 22797));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 23829));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 24861));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 25893));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 26925));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 27957));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 28989));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 30021));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 31053));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 32085));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __VERIFIER_nondet_long: ref;
axiom (__VERIFIER_nondet_long == $sub.ref(0, 33117));
...
axiom (__SMACK_nondet_long == $sub.ref(0, 34149));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 35181));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 36213));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 37245));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 38277));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 39309));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 40341));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 41373));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 42405));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 43437));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 44469));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 45501));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 46533));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 47565));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 48597));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 49629));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 50661));
...
axiom (llvm.dbg.value == $sub.ref(0, 51693));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 52725));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.bytes.bv32($M.0, array1_size, 16bv32);
  call {:cexpr "array1_size"} boogie_si_record_bv32(16bv32);
  $M.0 := $store.bytes.bv8($M.0, array1, 1bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(1, 1)), 2bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(2, 1)), 3bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(3, 1)), 4bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(4, 1)), 5bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(5, 1)), 6bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(6, 1)), 7bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(7, 1)), 8bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(8, 1)), 9bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(9, 1)), 10bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(10, 1)), 11bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(11, 1)), 12bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(12, 1)), 13bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(13, 1)), 14bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(14, 1)), 15bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(15, 1)), 16bv8);
  $M.0 := $store.bytes.ref($M.0, spectre_secret, .str);
  $M.0 := $store.bytes.bv8($M.0, temp, 0bv8);
  call {:cexpr "temp"} boogie_si_record_bv8(0bv8);
  $M.0 := $store.bytes.bv8($M.0, array2, 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(1, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(2, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(3, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(4, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(5, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(6, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(7, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(8, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(9, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(10, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(11, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(12, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(13, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(14, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(15, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(16, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(17, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(18, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(19, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(20, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(21, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(22, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(23, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(24, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(25, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(26, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(27, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(28, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(29, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(30, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(31, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(32, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(33, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(34, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(35, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(36, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(37, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(38, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(39, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(40, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(41, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(42, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(43, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(44, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(45, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(46, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(47, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(48, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(49, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(50, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(51, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(52, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(53, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(54, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(55, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(56, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(57, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(58, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(59, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(60, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(61, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(62, 1)), 0bv8);
  $M.0 := $store.bytes.bv8($M.0, $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref(63, 1)), 0bv8);
  $M.0 := $store.bytes.ref($M.0, env_value_str, .str.1.7);
