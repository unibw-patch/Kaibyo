...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv11 -fms-extensions -I../../include/ -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/v11.o0.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 51651));
...
axiom (.str.1 == $sub.ref(0, 6246));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 7278));
const {:count 3} .str.1.5: ref;
axiom (.str.1.5 == $sub.ref(0, 8305));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 9343));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 10371));
const mymemcmp: ref;
axiom (mymemcmp == $sub.ref(0, 11403));
  ...
  returns ($r: bv32)
{
  ...
  var $i8: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 167, 10} true;
  ...
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/spectre/spectre.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/spectre/spectre.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/spectre/spectre.c", 167, 32} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.bv32(0bv32, $i4);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 167, 5} true;
  assume {:verifier.code 0} true;
  $i8 := $i6;
...
$bb2:
  assume ($i7 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 168, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $load.bv8($M.0, $p3);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 168, 20} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.bv8.bv32($i9);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 168, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.bv8($M.0, $p5);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 168, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.bv8.bv32($i11);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 168, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.bv32($i10, $i12);
  call {:cexpr "res"} boogie_si_record_bv32($i13);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 168, 33} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.bv32($i13, 0bv32);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 168, 13} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/spectre/spectre.c", 172, 5} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $exn := false;
  return;
$bb5:
  assume ($i14 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 169, 13} true;
  assume {:verifier.code 0} true;
  $i8 := $i13;
  goto $bb4;
$bb6:
  assume !(($i14 == 1bv1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 171, 5} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 167, 41} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p3, $mul.ref(1, 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 167, 48} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p5, $mul.ref(1, 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 167, 60} true;
  assume {:verifier.code 0} true;
...
axiom (victim_function_v11 == $sub.ref(0, 12435));
procedure  victim_function_v11($i0: bv64)
{
  ...
  var $i10: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 175, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 175, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 175, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 50} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 50} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bytes.bv8($M.0, $p4);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 49} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.bv8.bv32($i5);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 47} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.bv32.bv64($i6);
  $p8 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i7), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 18} true;
  assume {:verifier.code 0} true;
  call $i9 := mymemcmp(temp, $p8, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.bv32.bv8($i9);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv8($M.0, temp, $i10);
  call {:cexpr "temp"} boogie_si_record_bv8($i10);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 176, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 175, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 177, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 13467));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/spectre/spectre.c", 243, 16} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 244, 13} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 278, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v11($i0);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 292, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
...
axiom (__VERIFIER_assume == $sub.ref(0, 14499));
...
axiom (__SMACK_code == $sub.ref(0, 15531));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 16563));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17595));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 18627));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 19659));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 20691));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 21723));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 22755));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 23787));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 24819));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 25851));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 26883));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 27915));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 28947));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 29979));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 31011));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __VERIFIER_nondet_long: ref;
axiom (__VERIFIER_nondet_long == $sub.ref(0, 32043));
...
axiom (__SMACK_nondet_long == $sub.ref(0, 33075));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 34107));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 35139));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 36171));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 37203));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 38235));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 39267));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 40299));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 41331));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 42363));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 43395));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 44427));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 45459));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 46491));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 47523));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 48555));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 49587));
...
axiom (llvm.dbg.value == $sub.ref(0, 50619));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 51651));
