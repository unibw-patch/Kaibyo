...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv02 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v02.o0.bpl
...
axiom (leakByteLocalFunction == $sub.ref(0, 12477));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 40, 49} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i1), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 40, 49} true;
  assume {:verifier.code 0} true;
  $i3 := $load.bv8($M.0, $p2);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 40, 49} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 40, 62} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const victim_function_v02: ref;
axiom (victim_function_v02 == $sub.ref(0, 13509));
procedure  victim_function_v02($i0: bv64)
{
  var $i1: bv32;
  var $i2: bv64;
  var $i3: bv1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v02:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 42, 14} true;
  assume {:verifier.code 0} true;
