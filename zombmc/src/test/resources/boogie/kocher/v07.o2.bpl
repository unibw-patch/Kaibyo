...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-O2 -Dv07 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v07.o2.bpl
...
axiom (llvm.dbg.value == $sub.ref(0, 13509));
...
$bb0:
  ...
  $i2 := $load.bv64($M.0, victim_function_v07.last_x);
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 19} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(array2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i6), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 19} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $i11 := $load.bytes.bv32($M.0, array1_size);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 113, 14} true;
  assume {:verifier.code 0} true;
