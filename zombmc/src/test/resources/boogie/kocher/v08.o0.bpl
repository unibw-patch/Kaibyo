...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv08 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v08.o0.bpl
...
axiom (victim_function_v08 == $sub.ref(0, 12477));
procedure  victim_function_v08($i0: bv64)
{
  var $i1: bv32;
  var $i2: bv64;
  var $i3: bv1;
  ...
  var $i15: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 32} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v08:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 32} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 30} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 28} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 49} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 28} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/spectre/spectre.c", 123, 21} true;
  assume {:verifier.code 0} true;
