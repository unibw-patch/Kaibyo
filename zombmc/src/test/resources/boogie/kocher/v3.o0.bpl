...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv03 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v03.o0.bpl
...
axiom (leakByteNoinlineFunction == $sub.ref(0, 12477));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 55, 86} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const victim_function_v03: ref;
axiom (victim_function_v03 == $sub.ref(0, 13509));
procedure  victim_function_v03($i0: bv64)
{
  var $i1: bv32;
  var $i2: bv64;
  var $i3: bv1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v03:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 57, 14} true;
  assume {:verifier.code 0} true;
