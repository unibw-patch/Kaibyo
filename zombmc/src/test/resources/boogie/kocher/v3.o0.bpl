...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv3 -fms-extensions -I../../include/ -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/v3.o0.bpl
...
axiom (leakByteNoinlineFunction == $sub.ref(0, 11403));
procedure  leakByteNoinlineFunction($i0: bv8)
{
  ...
  var $i8: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 55, 73} true;
  ...
  assume {:verifier.code 0} true;
  $i4 := $zext.bv8.bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 55, 70} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 55, 92} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const victim_function_v3: ref;
axiom (victim_function_v3 == $sub.ref(0, 12435));
procedure  victim_function_v3($i0: bv64)
{
  ...
  var $i5: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 57, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 57, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 57, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 58, 36} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 58, 36} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bytes.bv8($M.0, $p4);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 58, 11} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 59, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 254, 5} true;
  assume {:verifier.code 0} true;
