...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-O2 -Dv12 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v12.o2.bpl
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($bv2int.64($i2), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 188, 26} true;
  assume {:verifier.code 0} true;
