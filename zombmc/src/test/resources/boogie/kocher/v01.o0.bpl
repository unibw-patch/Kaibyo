...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv01 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v01.o0.bpl
...
axiom (victim_function_v01 == $sub.ref(0, 12477));
procedure  victim_function_v01($i0: bv64)
{
  var $i1: bv32;
  var $i2: bv64;
  var $i3: bv1;
...
$bb0:
  ...
  call {:cexpr "victim_function_v01:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 30, 14} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 31, 26} true;
  assume {:verifier.code 0} true;
