...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv10 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v10.o0.bpl
...
axiom (victim_function_v10 == $sub.ref(0, 12477));
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 150, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $zext.bv8.bv32($i6);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 150, 28} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.bv8.bv32($i1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 150, 25} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.bv32($i7, $i8);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 150, 15} true;
  assume {:verifier.code 0} true;
