...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv10 -fms-extensions -I../../include/ -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/v10.o0.bpl
...
axiom (victim_function_v10 == $sub.ref(0, 11403));
procedure  victim_function_v10($i0: bv64, $i1: bv8)
{
  ...
  var $i15: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 149, 14} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 149, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.bv64($i0, $i3);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 149, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 150, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $zext.bv8.bv32($i6);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 150, 33} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.bv8.bv32($i1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 150, 30} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.bv32($i7, $i8);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 150, 15} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 153, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume ($i9 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 151, 24} true;
  assume {:verifier.code 0} true;
  $i10 := $load.bytes.bv8($M.0, publicarray2);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 151, 24} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.bv8.bv32($i10);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 151, 21} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 151, 16} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 150, 15} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 152, 6} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
const main: ref;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 275, 5} true;
  assume {:verifier.code 0} true;
