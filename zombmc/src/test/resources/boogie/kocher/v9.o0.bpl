...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv9 -fms-extensions -I../../include/ -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/v9.o0.bpl
...
axiom (victim_function_v9 == $sub.ref(0, 11403));
procedure  victim_function_v9($i0: bv64, $p1: ref)
{
  ...
  var $i13: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 134, 10} true;
...
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 135, 32} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 135, 32} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bytes.bv8($M.0, $p4);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 135, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.bv8.bv64($i5);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 135, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.bv8.bv32($i8);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 135, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 135, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 134, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 136, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 244, 9} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv32($M.0, $p0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 272, 5} true;
  assume {:verifier.code 0} true;
