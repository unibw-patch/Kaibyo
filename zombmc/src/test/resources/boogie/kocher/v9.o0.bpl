...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv09 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v09.o0.bpl
...
axiom (victim_function_v09 == $sub.ref(0, 12477));
procedure  victim_function_v09($i0: bv64, $p1: ref)
{
  var $i2: bv32;
  var $i3: bv1;
  var $p4: ref;
...
$bb0:
  ...
  call {:cexpr "victim_function_v09:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 134, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $load.bv32($M.0, $p1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 134, 10} true;
...
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 135, 26} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call victim_function_v09($i1, $p0);
