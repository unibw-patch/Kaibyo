...
// via /usr/local/bin/smack /Users/ponce/git/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv13 -fms-extensions -I../../include/ -bpl /Users/ponce/git/Dat3M/benchmarks/spectre/bpl/v13.o0.bpl
...
const is_x_safe: ref;
axiom (is_x_safe == $sub.ref(0, 12477));
...
axiom (victim_function_v13 == $sub.ref(0, 13509));
...
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 206, 26} true;
  assume {:verifier.code 0} true;
