...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-Dv7 -fms-extensions -I../../include/ -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/v7.o0.bpl
...
axiom (victim_function_v7.last_x == $sub.ref(0, 6238));
...
axiom (victim_function_v7 == $sub.ref(0, 12435));
procedure  victim_function_v7($i0: bv64)
{
  ...
  var $i15: bv1;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 111, 15} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v7:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 111, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv64($M.0, victim_function_v7.last_x);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 111, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.bv64($i0, $i1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 111, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 32} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 32} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bytes.bv8($M.0, $p3);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.bv8.bv64($i4);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $zext.bv8.bv32($i7);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 112, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 111, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 113, 14} true;
  assume {:verifier.code 0} true;
  $i13 := $load.bytes.bv32($M.0, publicarray_size);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 113, 14} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.bv32.bv64($i13);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 113, 12} true;
  assume {:verifier.code 0} true;
  $i15 := $ult.bv64($i0, $i14);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 113, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i15 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 114, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv64($M.0, victim_function_v7.last_x, $i0);
  call {:cexpr "victim_function_v7.last_x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre.c", 114, 11} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 113, 10} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "benchmarks/spectre/spectre.c", 115, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre.c", 266, 5} true;
  assume {:verifier.code 0} true;
