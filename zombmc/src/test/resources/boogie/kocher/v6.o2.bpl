...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-O2 -Dv6 -fms-extensions -I../../include/ -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/v6.o2.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 50615));
...
axiom (llvm.dbg.value == $sub.ref(0, 12431));
...
axiom (__SMACK_static_init == $sub.ref(0, 50615));
