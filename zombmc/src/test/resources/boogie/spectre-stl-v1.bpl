...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv1 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v1.bpl
...
axiom (victim_function_v1 == $sub.ref(0, 13577));
procedure  victim_function_v1($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv32;
  ...
  var $i13: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 36, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v1:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 36, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 36, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.bv32($i1, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 36, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv32($i0, $i2);
  call {:cexpr "ridx"} boogie_si_record_bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 43, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.bv32.bv64($i3);
  $p5 := $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref($bv2int.64($i4), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 43, 32} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p5, 0bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 46, 24} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.bv32.bv64($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 46, 24} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref($bv2int.64($i6), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 46, 24} true;
  assume {:verifier.code 0} true;
  $i8 := $load.bv32($M.0, $p7);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 46, 11} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.bv32.bv64($i8);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 46, 11} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i9), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 46, 11} true;
  assume {:verifier.code 0} true;
  $i11 := $load.bv32($M.0, $p10);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 46, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 47, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 250, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v1($i1);
