...
// via /usr/local/bin/smack spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-m32 -Dv14 -Dzombmc -bpl bpl/spectre-stl-v14.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 52675));
...
function {:builtin "bv2nat"} $bv2uint.32(i: bv32) returns (i32);
function {:inline} $bv2int.32(i: bv32) returns (i32) { (if $slt.bv32.bool(i, 0bv32) then $sub.i32($bv2uint.32(i), 4294967296) else $bv2uint.32(i)) }
...
function {:inline} $load.bytes.ref(M: [ref] bv8, p: ref) returns (ref) { $i2p.bv32.ref($load.bytes.bv32(M, p)) }
function {:inline} $store.bytes.ref(M: [ref] bv8, p: ref, p1: ref) returns ([ref] bv8) { $store.bytes.bv32(M, p, $p2i.ref.bv32(p1)) }
...
function {:inline} $p2i.ref.bv8(p: ref) returns (bv8) { $trunc.bv32.bv8($int2bv.32(p)) }
function {:inline} $i2p.bv8.ref(i: bv8) returns (ref) { $bv2int.32($zext.bv8.bv32(i)) }
function {:inline} $p2i.ref.bv16(p: ref) returns (bv16) { $trunc.bv32.bv16($int2bv.32(p)) }
function {:inline} $i2p.bv16.ref(i: bv16) returns (ref) { $bv2int.32($zext.bv16.bv32(i)) }
function {:inline} $p2i.ref.bv32(p: ref) returns (bv32) { $int2bv.32(p) }
function {:inline} $i2p.bv32.ref(i: bv32) returns (ref) { $bv2int.32(i) }
function {:inline} $p2i.ref.bv64(p: ref) returns (bv64) { $zext.bv32.bv64($int2bv.32(p)) }
function {:inline} $i2p.bv64.ref(i: bv64) returns (ref) { $bv2int.32($trunc.bv64.bv32(i)) }
...
const llvm.used: ref;
axiom (llvm.used == $sub.ref(0, 7376));
const {:count 16} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 8416));
const {:count 28} .str.17: ref;
axiom (.str.17 == $sub.ref(0, 9468));
const {:count 26} .str.18: ref;
axiom (.str.18 == $sub.ref(0, 10518));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 11546));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 12573));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 13611));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 14639));
const victim_function_v14: ref;
axiom (victim_function_v14 == $sub.ref(0, 15667));
procedure  victim_function_v14($i0: bv32)
{
  ...
  var $i6: bv32;
$bb0:
  assume {:sourceloc "spectre-stl.c", 243, 3} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v14:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre-stl.c", 243, 3} true;
  assume {:verifier.code 0} true;
  $p1 := $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref($bv2int.32($i0), 4));
  assume {:sourceloc "spectre-stl.c", 243, 20} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p1, 2bv32);
  assume {:sourceloc "spectre-stl.c", 244, 24} true;
  assume {:verifier.code 0} true;
  $i2 := $load.bv32($M.0, publicarray);
  assume {:sourceloc "spectre-stl.c", 244, 11} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.32($i2), 4));
  assume {:sourceloc "spectre-stl.c", 244, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, $p3);
  assume {:sourceloc "spectre-stl.c", 244, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre-stl.c", 245, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 16695));
...
$bb0:
  call $initialize();
  assume {:sourceloc "spectre-stl.c", 253, 12} true;
  ...
  assume {:sourceloc "spectre-stl.c", 253, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, idxg, $i0);
  call {:cexpr "idxg"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre-stl.c", 254, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "spectre-stl.c", 297, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v14($i1);
  assume {:sourceloc "spectre-stl.c", 299, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
...
axiom (__VERIFIER_assume == $sub.ref(0, 17723));
...
axiom (__SMACK_code == $sub.ref(0, 18751));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 19779));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 20807));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 21835));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 22863));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 23891));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 24919));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 25947));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 26975));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 28003));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 29031));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 30059));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 31087));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 32115));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 33143));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 34171));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 35199));
procedure  __SMACK_nondet_long()
  returns ($r: bv32);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 36227));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 37255));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv32);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 38283));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 39311));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 40339));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv32);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 41367));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 42395));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 43423));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 44451));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 45479));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 46507));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 47535));
...
axiom (__SMACK_decls == $sub.ref(0, 48563));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 49591));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 50619));
...
axiom (__SMACK_static_init == $sub.ref(0, 52675));
