...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv12 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v12.bpl
...
const case_12_mask: ref;
axiom (case_12_mask == $sub.ref(0, 13577));
procedure  case_12_mask($i0: bv32)
  returns ($r: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 211, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "case_12_mask:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 211, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 211, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.bv32($i1, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 211, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv32($i0, $i2);
  call {:cexpr "ridx"} boogie_si_record_bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 212, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
axiom (victim_function_v12 == $sub.ref(0, 14609));
procedure  victim_function_v12($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv64;
  var $p3: ref;
  ...
  var $i9: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 216, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v12:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 216, 10} true;
  assume {:verifier.code 0} true;
  call $i1 := case_12_mask($i0);
  call {:cexpr "ridx"} boogie_si_record_bv32($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 219, 24} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.bv32.bv64($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 219, 24} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref($bv2int.64($i2), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 219, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, $p3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 219, 11} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.bv32.bv64($i4);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 219, 11} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i5), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 219, 11} true;
  assume {:verifier.code 0} true;
  $i7 := $load.bv32($M.0, $p6);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 219, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 220, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 283, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v12($i1);
