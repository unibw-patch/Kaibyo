...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv8 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v8.o0.bpl
...
const victim_function_v8: ref;
axiom (victim_function_v8 == $sub.ref(0, 12435));
procedure  victim_function_v8($i0: bv64)
{
  var $i1: bv32;
  var $i2: bv64;
  var $i3: bv1;
  ...
  var $i15: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 43} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v8:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 43} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 41} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 39} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 65} true;
  assume {:verifier.code 0} true;
  $i4 := $add.bv64($i0, 1bv64);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 39} true;
  assume {:verifier.code 0} true;
  $i5 := $i4;
  goto $bb3;
...
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 39} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 27} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i5), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 27} true;
  assume {:verifier.code 0} true;
  $i7 := $load.bytes.bv8($M.0, $p6);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 14} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.bv8.bv64($i7);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 122, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 270, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v8($i0);
