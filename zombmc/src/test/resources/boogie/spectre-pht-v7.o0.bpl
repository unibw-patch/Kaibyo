...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv7 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v7.o0.bpl
...
const victim_function_v7.last_x: ref;
axiom (victim_function_v7.last_x == $sub.ref(0, 7270));
const {:count 16} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 8310));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 9342));
const {:count 3} .str.1.5: ref;
axiom (.str.1.5 == $sub.ref(0, 10369));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 11407));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 12435));
const victim_function_v7: ref;
axiom (victim_function_v7 == $sub.ref(0, 13467));
procedure  victim_function_v7($i0: bv64)
{
  var $i1: bv64;
  var $i2: bv1;
  var $p3: ref;
  ...
  var $i15: bv1;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 109, 15} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v7:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 109, 15} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv64($M.0, victim_function_v7.last_x);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 109, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.bv64($i0, $i1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 109, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 32} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 32} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bytes.bv8($M.0, $p3);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.bv8.bv64($i4);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 19} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i5), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $load.bytes.bv8($M.0, $p6);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.bv8.bv32($i7);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $load.bytes.bv8($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv8($M.0, temp, $i12);
  call {:cexpr "temp"} boogie_si_record_bv8($i12);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 109, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 111, 14} true;
  assume {:verifier.code 0} true;
  $i13 := $load.bytes.bv32($M.0, publicarray_size);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 111, 14} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.bv32.bv64($i13);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 111, 12} true;
  assume {:verifier.code 0} true;
  $i15 := $ult.bv64($i0, $i14);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 111, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i15} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i15 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 112, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv64($M.0, victim_function_v7.last_x, $i0);
  call {:cexpr "victim_function_v7.last_x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 112, 11} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 111, 10} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 113, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 267, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v7($i0);
...
$bb0:
  ...
  $M.0 := $store.bytes.bv64($M.0, victim_function_v7.last_x, 0bv64);
  call {:cexpr "victim_function_v7.last_x"} boogie_si_record_bv64(0bv64);
