...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -O2 -Dv7 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v7.o2.bpl
...
axiom (llvm.dbg.value == $sub.ref(0, 13467));
...
$bb0:
  ...
  $i2 := $load.bv64($M.0, victim_function_v7.last_x);
...
$bb1:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 19} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i6), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 110, 19} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $i11 := $load.bytes.bv32($M.0, publicarray_size);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 111, 14} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.bv32.bv64($i11);
