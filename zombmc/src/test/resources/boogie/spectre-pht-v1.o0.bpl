...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv1 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v1.o0.bpl
...
const victim_function_v1: ref;
axiom (victim_function_v1 == $sub.ref(0, 12435));
procedure  victim_function_v1($i0: bv64)
{
  var $i1: bv32;
  var $i2: bv64;
  var $i3: bv1;
  ...
  var $i13: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 28, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v1:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 28, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 28, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 28, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 29, 32} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 29, 32} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bytes.bv8($M.0, $p4);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 29, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.bv8.bv64($i5);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 29, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.bv8.bv32($i8);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 29, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 30, 6} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 28, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 249, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v1($i0);
