...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv9 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v9.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 52793));
...
const idxg: ref;
axiom (idxg == $sub.ref(0, 6348));
const llvm.used: ref;
axiom (llvm.used == $sub.ref(0, 7380));
const {:count 16} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 8420));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 9452));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 10479));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 11517));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 12545));
const victim_function_v9: ref;
axiom (victim_function_v9 == $sub.ref(0, 13577));
procedure  victim_function_v9($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv32;
  ...
  var $i18: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 148, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v9:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 148, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 148, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.bv32($i1, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 148, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv32($i0, $i2);
  call {:cexpr "ridx"} boogie_si_record_bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 151, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.bv32.bv64($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 151, 3} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref($bv2int.64($i4), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 151, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p5, 0bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 154, 8} true;
  assume {:verifier.code 0} true;
  $i6 := 0bv32;
  goto $bb1;
$bb1:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 154, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $ult.bv32($i6, 200bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 154, 3} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb2, $bb3;
$bb2:
  assume ($i7 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 154, 34} true;
  assume {:verifier.code 0} true;
  $i8 := $load.bv32($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 154, 34} true;
  assume {:verifier.code 0} true;
  $i9 := $and.bv32($i8, $i6);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 154, 34} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, temp, $i9);
  call {:cexpr "temp"} boogie_si_record_bv32($i9);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 154, 29} true;
  assume {:verifier.code 0} true;
  goto $bb4;
$bb3:
  assume !(($i7 == 1bv1));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 157, 24} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.bv32.bv64($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 157, 24} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref($bv2int.64($i11), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 157, 24} true;
  assume {:verifier.code 0} true;
  $i13 := $load.bv32($M.0, $p12);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 157, 11} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.bv32.bv64($i13);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 157, 11} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i14), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 157, 11} true;
  assume {:verifier.code 0} true;
  $i16 := $load.bv32($M.0, $p15);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 157, 8} true;
  assume {:verifier.code 0} true;
  $i17 := $load.bv32($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 157, 8} true;
  assume {:verifier.code 0} true;
  $i18 := $and.bv32($i17, $i16);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 157, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, temp, $i18);
  call {:cexpr "temp"} boogie_si_record_bv32($i18);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 158, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 154, 24} true;
  assume {:verifier.code 0} true;
  $i10 := $add.bv32($i6, 1bv32);
  call {:cexpr "i"} boogie_si_record_bv32($i10);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 154, 3} true;
  assume {:verifier.code 0} true;
  $i6 := $i10;
  goto $bb1;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 274, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v9($i1);
...
axiom (__VERIFIER_assume == $sub.ref(0, 15641));
...
axiom (__SMACK_code == $sub.ref(0, 16673));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 17705));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18737));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 19769));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 20801));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 21833));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 22865));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 23897));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 24929));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 25961));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 26993));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 28025));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 29057));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 30089));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 31121));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 32153));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 33185));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 34217));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 35249));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 36281));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 37313));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 38345));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 39377));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 40409));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 41441));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 42473));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 43505));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 44537));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 45569));
...
axiom (__SMACK_decls == $sub.ref(0, 46601));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 47633));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 48665));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 49697));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 50729));
...
axiom (llvm.dbg.value == $sub.ref(0, 51761));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 52793));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.bv32($M.0, array_size, 16bv32);
  call {:cexpr "array_size"} boogie_si_record_bv32(16bv32);
  $M.0 := $store.bv32($M.0, publicarray, 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(1, 4)), 1bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(2, 4)), 2bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(3, 4)), 3bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(4, 4)), 4bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(5, 4)), 5bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(6, 4)), 6bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(7, 4)), 7bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(8, 4)), 8bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(9, 4)), 9bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(10, 4)), 10bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(11, 4)), 11bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(12, 4)), 12bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(13, 4)), 13bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(14, 4)), 14bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(15, 4)), 15bv32);
  $M.0 := $store.bv32($M.0, publicarray2, 20bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(0, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(1, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(2, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(3, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(4, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(5, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(6, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(7, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(8, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(9, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(10, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(11, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(12, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(13, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(14, 4)), 0bv32);
  $M.0 := $store.bv32($M.0, secretarray, 10bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(1, 4)), 21bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(2, 4)), 32bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(3, 4)), 43bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(4, 4)), 54bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(5, 4)), 65bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(6, 4)), 76bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(7, 4)), 87bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(8, 4)), 98bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(9, 4)), 109bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(10, 4)), 110bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(11, 4)), 121bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(12, 4)), 132bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(13, 4)), 143bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(14, 4)), 154bv32);
  $M.0 := $store.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(15, 4)), 165bv32);
  $M.0 := $store.bv32($M.0, temp, 0bv32);
  call {:cexpr "temp"} boogie_si_record_bv32(0bv32);
  $M.0 := $store.bv32($M.0, idxg, 0bv32);
