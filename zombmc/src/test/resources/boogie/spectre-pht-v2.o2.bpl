...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -O2 -Dv2 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v2.o2.bpl
...
$bb1:
  ...
  call {:cexpr "k"} boogie_si_record_bv8($i6);
