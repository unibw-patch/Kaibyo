...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -O2 -Dv3 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v3.o2.bpl
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i4 := $load.bv8($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 53, 70} true;
  assume {:verifier.code 0} true;
  $i5 := $and.bv8($i4, $i3);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 53, 70} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, temp, $i5);
  call {:cexpr "temp"} boogie_si_record_bv8($i5);
