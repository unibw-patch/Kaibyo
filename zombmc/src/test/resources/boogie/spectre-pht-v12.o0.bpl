...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv12 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v12.o0.bpl
...
axiom (victim_function_v12 == $sub.ref(0, 12435));
procedure  victim_function_v12($i0: bv64, $i1: bv64)
{
  var $i2: bv64;
  var $i3: bv32;
  var $i4: bv64;
  ...
  var $i16: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 185, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v12:arg:x"} boogie_si_record_bv64($i0);
  call {:cexpr "victim_function_v12:arg:y"} boogie_si_record_bv64($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 185, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $add.bv64($i0, $i1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 185, 20} true;
  assume {:verifier.code 0} true;
  $i3 := $load.bv32($M.0, publicarray_size);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 185, 20} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.bv32.bv64($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 185, 18} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.bv64($i2, $i4);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 185, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i5 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 46} true;
  assume {:verifier.code 0} true;
  $i6 := $add.bv64($i0, $i1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 32} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i6), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 32} true;
  assume {:verifier.code 0} true;
  $i8 := $load.bytes.bv8($M.0, $p7);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $zext.bv8.bv64($i8);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 19} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i9), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $load.bytes.bv8($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 16} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.bv8.bv32($i13);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 16} true;
  assume {:verifier.code 0} true;
  $i15 := $and.bv32($i14, $i12);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 16} true;
  assume {:verifier.code 0} true;
  $i16 := $trunc.bv32.bv8($i15);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv8($M.0, temp, $i16);
  call {:cexpr "temp"} boogie_si_record_bv8($i16);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 186, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 185, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 187, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 282, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v12($i0, $i0);
