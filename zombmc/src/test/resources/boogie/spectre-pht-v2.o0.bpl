...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv2 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v2.o0.bpl
...
axiom (leakByteLocalFunction == $sub.ref(0, 12435));
procedure  leakByteLocalFunction($i0: bv8)
{
  var $i1: bv64;
  var $p2: ref;
  var $i3: bv8;
  ...
  var $i8: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 38, 49} true;
  assume {:verifier.code 0} true;
  call {:cexpr "leakByteLocalFunction:arg:k"} boogie_si_record_bv8($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 38, 49} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.bv8.bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 38, 49} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i1), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 38, 49} true;
  assume {:verifier.code 0} true;
  $i3 := $load.bv8($M.0, $p2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 38, 49} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.bv8.bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 38, 46} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bv8($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 38, 46} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.bv8.bv32($i5);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 38, 46} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 38, 46} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, temp, $i8);
  call {:cexpr "temp"} boogie_si_record_bv8($i8);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 38, 68} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const victim_function_v2: ref;
axiom (victim_function_v2 == $sub.ref(0, 13467));
procedure  victim_function_v2($i0: bv64)
{
  var $i1: bv32;
  var $i2: bv64;
  var $i3: bv1;
  ...
  var $i5: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 40, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v2:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 40, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 40, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 40, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 41, 33} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 41, 33} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bytes.bv8($M.0, $p4);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 41, 11} true;
  assume {:verifier.code 0} true;
  call leakByteLocalFunction($i5);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 42, 6} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 40, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 43, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 252, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v2($i0);
