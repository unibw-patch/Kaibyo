...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -O2 -Dv9 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v9.o2.bpl
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $i8 := $load.bv8($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 133, 16} true;
  assume {:verifier.code 0} true;
  $i9 := $and.bv8($i8, $i7);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 133, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv8($M.0, temp, $i9);
  call {:cexpr "temp"} boogie_si_record_bv8($i9);
