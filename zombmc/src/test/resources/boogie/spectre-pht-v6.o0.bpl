...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv6 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v6.o0.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 52679));
...
axiom (array_size_mask == $sub.ref(0, 4121));
const {:count 64} publicarray2: ref;
axiom (publicarray2 == $sub.ref(0, 5209));
const secret: ref;
axiom (secret == $sub.ref(0, 6234));
const llvm.used: ref;
axiom (llvm.used == $sub.ref(0, 7266));
const {:count 16} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 8306));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 9338));
const {:count 3} .str.1.5: ref;
axiom (.str.1.5 == $sub.ref(0, 10365));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 11403));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 12431));
const victim_function_v6: ref;
axiom (victim_function_v6 == $sub.ref(0, 13463));
procedure  victim_function_v6($i0: bv64)
{
  var $i1: bv32;
  var $i2: bv64;
  var $i3: bv64;
  ...
  var $i14: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 96, 15} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v6:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 96, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 96, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 96, 32} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.bv64($i3, $i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 96, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 97, 32} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 97, 32} true;
  assume {:verifier.code 0} true;
  $i6 := $load.bytes.bv8($M.0, $p5);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 97, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.bv8.bv64($i6);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 97, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 97, 16} true;
  assume {:verifier.code 0} true;
  $i11 := $load.bytes.bv8($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 97, 16} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.bv8.bv32($i11);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 97, 16} true;
  assume {:verifier.code 0} true;
  $i13 := $and.bv32($i12, $i10);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 97, 16} true;
  assume {:verifier.code 0} true;
  $i14 := $trunc.bv32.bv8($i13);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 97, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv8($M.0, temp, $i14);
  call {:cexpr "temp"} boogie_si_record_bv8($i14);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 97, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 96, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 98, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 14495));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 264, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v6($i0);
...
axiom (__VERIFIER_assume == $sub.ref(0, 15527));
...
axiom (__SMACK_code == $sub.ref(0, 16559));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 17591));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18623));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 19655));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 20687));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 21719));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 22751));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 23783));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 24815));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 25847));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 26879));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 27911));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 28943));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 29975));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 31007));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 32039));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __VERIFIER_nondet_long: ref;
axiom (__VERIFIER_nondet_long == $sub.ref(0, 33071));
...
axiom (__SMACK_nondet_long == $sub.ref(0, 34103));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 35135));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 36167));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 37199));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 38231));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 39263));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 40295));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 41327));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 42359));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 43391));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 44423));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 45455));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 46487));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 47519));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 48551));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 49583));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 50615));
...
axiom (llvm.dbg.value == $sub.ref(0, 51647));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 52679));
