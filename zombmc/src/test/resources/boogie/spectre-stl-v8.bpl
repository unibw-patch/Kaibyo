...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv8 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v8.bpl
...
const case8_mult: ref;
axiom (case8_mult == $sub.ref(0, 6348));
const idxg: ref;
...
axiom (victim_function_v8 == $sub.ref(0, 14605));
procedure  victim_function_v8($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv64;
  ...
  var $i10: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 135, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v8:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 135, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, case8_mult, 0bv32);
  call {:cexpr "case8_mult"} boogie_si_record_bv32(0bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 137, 39} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, case8_mult);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 137, 37} true;
  assume {:verifier.code 0} true;
  $i2 := $mul.bv32($i0, $i1);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 137, 21} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.bv32.bv64($i2);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 137, 21} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref($bv2int.64($i3), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 137, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bv32($M.0, $p4);
  call {:cexpr "toleak"} boogie_si_record_bv32($i5);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 138, 11} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.bv32.bv64($i5);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 138, 11} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i6), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 138, 11} true;
  assume {:verifier.code 0} true;
  $i8 := $load.bv32($M.0, $p7);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 138, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 139, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 271, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v8($i1);
...
$bb0:
  ...
  $M.0 := $store.bv32($M.0, case8_mult, 200bv32);
  call {:cexpr "case8_mult"} boogie_si_record_bv32(200bv32);
