...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -O2 -Dv5 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v5.o2.bpl
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  $i8 := $load.bytes.bv8($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 81, 10} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.bv32.bv64($i6);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 81, 10} true;
  assume {:verifier.code 0} true;
  $i10, $i11, $i12 := $i9, $i8, $i6;
  goto $bb6;
$bb5:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 81, 10} true;
  assume {:verifier.code 0} true;
...
$bb6:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 37} true;
  assume {:verifier.code 0} true;
  $p13 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i10), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 37} true;
  assume {:verifier.code 0} true;
  $i14 := $load.bytes.bv8($M.0, $p13);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 24} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.bv8.bv64($i14);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 24} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i15), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i19 := $add.bv32($i12, $sub.bv32(0bv32, 1bv32));
  call {:cexpr "i"} boogie_si_record_bv32($i19);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 81, 28} true;
  assume {:verifier.code 0} true;
  $i20 := $sgt.bv32($i12, 0bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 0, 0} true;
  assume {:verifier.code 0} true;
  $i21 := $add.bv64($i10, $sub.bv64(0bv64, 1bv64));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 81, 10} true;
  assume {:verifier.code 0} true;
