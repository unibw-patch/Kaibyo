...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv14 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v14.o0.bpl
...
axiom (victim_function_v14 == $sub.ref(0, 12435));
procedure  victim_function_v14($i0: bv64)
{
  var $i1: bv32;
  var $i2: bv64;
  var $i3: bv1;
  ...
  var $i14: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 215, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v14:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 215, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 215, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 215, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 216, 46} true;
  assume {:verifier.code 0} true;
  $i4 := $xor.bv64($i0, 255bv64);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 216, 32} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i4), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 216, 32} true;
  assume {:verifier.code 0} true;
  $i6 := $load.bytes.bv8($M.0, $p5);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 216, 19} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.bv8.bv64($i6);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 216, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 216, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 216, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 215, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 217, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 288, 5} true;
  assume {:verifier.code 0} true;
