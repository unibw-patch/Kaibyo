...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -O2 -Dv11 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v11.o2.bpl
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv8($M.0, temp, $i11);
  call {:cexpr "temp"} boogie_si_record_bv8($i11);
