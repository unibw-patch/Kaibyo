...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv13 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v13.bpl
...
const case_13_load_value: ref;
axiom (case_13_load_value == $sub.ref(0, 13577));
procedure  case_13_load_value($i0: bv32)
  returns ($r: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  ...
  var $i6: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 227, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "case_13_load_value:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 227, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 227, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.bv32($i1, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 227, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv32($i0, $i2);
  call {:cexpr "ridx"} boogie_si_record_bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 228, 22} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.bv32.bv64($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 228, 22} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref($bv2int.64($i4), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 228, 22} true;
  assume {:verifier.code 0} true;
  $i6 := $load.bv32($M.0, $p5);
  call {:cexpr "to_leak"} boogie_si_record_bv32($i6);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 229, 3} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
...
axiom (victim_function_v13 == $sub.ref(0, 14609));
procedure  victim_function_v13($i0: bv32)
{
  ...
  var $i6: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 233, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v13:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 233, 13} true;
  assume {:verifier.code 0} true;
  call $i1 := case_13_load_value($i0);
  call {:cexpr "to_leak"} boogie_si_record_bv32($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 236, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.bv32.bv64($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 236, 11} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i2), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 236, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, $p3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 236, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 237, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 286, 5} true;
  assume {:verifier.code 0} true;
