...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv13 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v13.o0.bpl
...
const is_x_safe: ref;
axiom (is_x_safe == $sub.ref(0, 12435));
procedure  is_x_safe($i0: bv64)
  returns ($r: bv32)
{
  var $i1: bv32;
  var $i2: bv64;
  ...
  var $i4: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 197, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "is_x_safe:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 197, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 197, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 197, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 198, 9} true;
  assume {:verifier.code 0} true;
  $i4 := 1bv32;
  goto $bb3;
$bb2:
  assume !(($i3 == 1bv1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 200, 5} true;
  assume {:verifier.code 0} true;
  $i4 := 0bv32;
  goto $bb3;
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 201, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
axiom (victim_function_v13 == $sub.ref(0, 13467));
procedure  victim_function_v13($i0: bv64)
{
  var $i1: bv32;
  var $i2: bv1;
  var $p3: ref;
  ...
  var $i12: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 203, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v13:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 203, 10} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 204, 32} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 204, 32} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bytes.bv8($M.0, $p3);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 204, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.bv8.bv64($i4);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 204, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $zext.bv8.bv32($i7);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 204, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 204, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 203, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 205, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 285, 5} true;
  assume {:verifier.code 0} true;
