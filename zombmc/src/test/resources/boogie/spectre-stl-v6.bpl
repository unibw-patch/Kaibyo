...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv6 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v6.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 54861));
...
const array_size: ref;
axiom (array_size == $sub.ref(0, 1028));
const {:count 16} publicarray: ref;
axiom (publicarray == $sub.ref(0, 2116));
const publicarray2: ref;
axiom (publicarray2 == $sub.ref(0, 3204));
const {:count 16} secretarray: ref;
axiom (secretarray == $sub.ref(0, 4292));
const temp: ref;
axiom (temp == $sub.ref(0, 5320));
const case6_idx: ref;
axiom (case6_idx == $sub.ref(0, 6348));
const {:count 2} case6_array: ref;
axiom (case6_array == $sub.ref(0, 7388));
const idxg: ref;
axiom (idxg == $sub.ref(0, 8416));
const llvm.used: ref;
axiom (llvm.used == $sub.ref(0, 9448));
const {:count 16} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 10488));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 11520));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 12547));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 13585));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 14613));
const victim_function_v6: ref;
axiom (victim_function_v6 == $sub.ref(0, 15645));
procedure  victim_function_v6($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv32;
  ...
  var $i15: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 113, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v6:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 113, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 113, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.bv32($i1, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 113, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv32($i0, $i2);
  call {:cexpr "ridx"} boogie_si_record_bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 115, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, case6_idx, 1bv32);
  call {:cexpr "case6_idx"} boogie_si_record_bv32(1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 117, 34} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, case6_idx);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 117, 22} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.bv32.bv64($i4);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 117, 22} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(case6_array, $mul.ref(0, 16)), $mul.ref($bv2int.64($i5), 8));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 117, 22} true;
  assume {:verifier.code 0} true;
  $p7 := $load.bytes.ref($M.0, $p6);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 117, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.bv32.bv64($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 117, 21} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($p7, $mul.ref($bv2int.64($i8), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 117, 21} true;
  assume {:verifier.code 0} true;
  $i10 := $load.bytes.bv32($M.0, $p9);
  call {:cexpr "toleak"} boogie_si_record_bv32($i10);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 118, 11} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.bv32.bv64($i10);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 118, 11} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i11), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 118, 11} true;
  assume {:verifier.code 0} true;
  $i13 := $load.bytes.bv32($M.0, $p12);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 118, 8} true;
  assume {:verifier.code 0} true;
  $i14 := $load.bytes.bv32($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 118, 8} true;
  assume {:verifier.code 0} true;
  $i15 := $and.bv32($i14, $i13);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 118, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv32($M.0, temp, $i15);
  call {:cexpr "temp"} boogie_si_record_bv32($i15);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 119, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 16677));
...
$bb0:
  call $initialize();
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 245, 12} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 245, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv32($M.0, idxg, $i0);
  call {:cexpr "idxg"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 246, 9} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 265, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v6($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 289, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
...
axiom (__VERIFIER_assume == $sub.ref(0, 17709));
...
axiom (__SMACK_code == $sub.ref(0, 18741));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 19773));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 20805));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 21837));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 22869));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 23901));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 24933));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 25965));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 26997));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 28029));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 29061));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 30093));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 31125));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 32157));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 33189));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 34221));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 35253));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 36285));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 37317));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 38349));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 39381));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 40413));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 41445));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 42477));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 43509));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 44541));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 45573));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 46605));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 47637));
...
axiom (__SMACK_decls == $sub.ref(0, 48669));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 49701));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 50733));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 51765));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 52797));
...
axiom (llvm.dbg.value == $sub.ref(0, 53829));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 54861));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.bytes.bv32($M.0, array_size, 16bv32);
  call {:cexpr "array_size"} boogie_si_record_bv32(16bv32);
  $M.0 := $store.bytes.bv32($M.0, publicarray, 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(1, 4)), 1bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(2, 4)), 2bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(3, 4)), 3bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(4, 4)), 4bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(5, 4)), 5bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(6, 4)), 6bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(7, 4)), 7bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(8, 4)), 8bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(9, 4)), 9bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(10, 4)), 10bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(11, 4)), 11bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(12, 4)), 12bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(13, 4)), 13bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(14, 4)), 14bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref(15, 4)), 15bv32);
  $M.0 := $store.bytes.bv32($M.0, publicarray2, 20bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(0, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(1, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(2, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(3, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(4, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(5, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(6, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(7, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(8, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(9, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(10, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(11, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(12, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(13, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref(4, 1)), $mul.ref(14, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, secretarray, 10bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(1, 4)), 21bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(2, 4)), 32bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(3, 4)), 43bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(4, 4)), 54bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(5, 4)), 65bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(6, 4)), 76bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(7, 4)), 87bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(8, 4)), 98bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(9, 4)), 109bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(10, 4)), 110bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(11, 4)), 121bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(12, 4)), 132bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(13, 4)), 143bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(14, 4)), 154bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref(15, 4)), 165bv32);
  $M.0 := $store.bytes.bv32($M.0, temp, 0bv32);
  call {:cexpr "temp"} boogie_si_record_bv32(0bv32);
  $M.0 := $store.bytes.bv32($M.0, case6_idx, 0bv32);
  call {:cexpr "case6_idx"} boogie_si_record_bv32(0bv32);
  $M.0 := $store.bytes.ref($M.0, case6_array, secretarray);
  $M.0 := $store.bytes.ref($M.0, $add.ref($add.ref(case6_array, $mul.ref(0, 16)), $mul.ref(1, 8)), publicarray);
  $M.0 := $store.bytes.bv32($M.0, idxg, 0bv32);
  call {:cexpr "idxg"} boogie_si_record_bv32(0bv32);
  $M.0 := $store.bytes.ref($M.0, llvm.used, secretarray);
