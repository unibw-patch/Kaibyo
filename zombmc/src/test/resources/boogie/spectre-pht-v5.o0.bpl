...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv5 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v5.o0.bpl
...
const victim_function_v5: ref;
axiom (victim_function_v5 == $sub.ref(0, 12435));
procedure  victim_function_v5($i0: bv64)
{
  var $i1: bv32;
  var $i2: bv64;
  var $i3: bv1;
  ...
  var $i19: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 80, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v5:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 80, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, publicarray_size);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 80, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.bv32.bv64($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 80, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv64($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 80, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 81, 21} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.bv64($i0, 1bv64);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 81, 19} true;
  assume {:verifier.code 0} true;
  $i5 := $trunc.bv64.bv32($i4);
  call {:cexpr "i"} boogie_si_record_bv32($i5);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 81, 15} true;
  assume {:verifier.code 0} true;
  $i6 := $i5;
  goto $bb4;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 85, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 81, 28} true;
  assume {:verifier.code 0} true;
  $i7 := $sge.bv32($i6, 0bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 81, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i7} true;
  goto $bb5, $bb6;
$bb5:
  assume ($i7 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 37} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.bv32.bv64($i6);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 37} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i8), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 37} true;
  assume {:verifier.code 0} true;
  $i10 := $load.bytes.bv8($M.0, $p9);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 24} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.bv8.bv64($i10);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 24} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i11), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 21} true;
  assume {:verifier.code 0} true;
  $i15 := $load.bytes.bv8($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 21} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.bv8.bv32($i15);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 21} true;
  assume {:verifier.code 0} true;
  $i17 := $and.bv32($i16, $i14);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 21} true;
  assume {:verifier.code 0} true;
  $i18 := $trunc.bv32.bv8($i17);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 82, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv8($M.0, temp, $i18);
  call {:cexpr "temp"} boogie_si_record_bv8($i18);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 83, 10} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !(($i7 == 1bv1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 84, 6} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 81, 35} true;
  assume {:verifier.code 0} true;
  $i19 := $add.bv32($i6, $sub.bv32(0bv32, 1bv32));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 261, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v5($i0);
