...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv10 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v10.bpl
...
const case_10_mask: ref;
axiom (case_10_mask == $sub.ref(0, 13577));
procedure  case_10_mask($i0: bv32)
  returns ($r: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 180, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "case_10_mask:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 180, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 180, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.bv32($i1, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 180, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv32($i0, $i2);
  call {:cexpr "ridx"} boogie_si_record_bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 181, 3} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
...
axiom (victim_function_v10 == $sub.ref(0, 14609));
procedure  victim_function_v10($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv64;
  var $p3: ref;
  ...
  var $i9: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 184, 19} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v10:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 184, 19} true;
  assume {:verifier.code 0} true;
  call $i1 := case_10_mask($i0);
  call {:cexpr "fidx"} boogie_si_record_bv32($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 187, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, $p3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 187, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $load.bv32($M.0, $p6);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 187, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 188, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 277, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v10($i1);
