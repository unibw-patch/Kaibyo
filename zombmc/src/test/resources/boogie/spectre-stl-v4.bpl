...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv4 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v4.bpl
...
axiom (victim_function_v4 == $sub.ref(0, 13577));
procedure  victim_function_v4($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv32;
  ...
  var $i13: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 85, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v4:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 85, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 85, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.bv32($i1, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 85, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv32($i0, $i2);
  call {:cexpr "ridx"} boogie_si_record_bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 88, 3} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.bv32.bv64($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 88, 3} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(secretarray, $mul.ref(0, 64)), $mul.ref($bv2int.64($i4), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 88, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, $p5, 0bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 91, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $load.bv32($M.0, $p7);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 91, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 91, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 92, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 259, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v4($i1);
