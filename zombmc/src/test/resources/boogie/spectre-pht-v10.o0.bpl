...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv10 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v10.o0.bpl
...
axiom (victim_function_v10 == $sub.ref(0, 12435));
procedure  victim_function_v10($i0: bv64, $i1: bv8)
{
  var $i2: bv32;
  var $i3: bv64;
  var $i4: bv1;
  ...
  var $i15: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 147, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v10:arg:x"} boogie_si_record_bv64($i0);
  call {:cexpr "victim_function_v10:arg:k"} boogie_si_record_bv8($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 147, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $load.bv32($M.0, publicarray_size);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 147, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.bv32.bv64($i2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 147, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.bv64($i0, $i3);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 147, 10} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 148, 15} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 148, 15} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $zext.bv8.bv32($i6);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 148, 33} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.bv8.bv32($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 148, 30} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.bv32($i7, $i8);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 148, 15} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 151, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume ($i9 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 149, 24} true;
  assume {:verifier.code 0} true;
  $i10 := $load.bytes.bv8($M.0, publicarray2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 149, 24} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.bv8.bv32($i10);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 149, 21} true;
  assume {:verifier.code 0} true;
  $i12 := $load.bytes.bv8($M.0, temp);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 149, 21} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.bv8.bv32($i12);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 149, 21} true;
  assume {:verifier.code 0} true;
  $i14 := $and.bv32($i13, $i11);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 149, 21} true;
  assume {:verifier.code 0} true;
  $i15 := $trunc.bv32.bv8($i14);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 149, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv8($M.0, temp, $i15);
  call {:cexpr "temp"} boogie_si_record_bv8($i15);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 149, 16} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 148, 15} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 150, 6} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
const main: ref;
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 276, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v10($i0, 10bv8);
