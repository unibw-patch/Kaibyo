...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv9 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v9.o0.bpl
...
const victim_function_v9: ref;
axiom (victim_function_v9 == $sub.ref(0, 12435));
procedure  victim_function_v9($i0: bv64, $p1: ref)
{
  var $i2: bv32;
  var $i3: bv1;
  var $p4: ref;
  ...
  var $i13: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 132, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v9:arg:x"} boogie_si_record_bv64($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 132, 10} true;
  assume {:verifier.code 0} true;
  $i2 := $load.bv32($M.0, $p1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 132, 10} true;
...
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 133, 32} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i0), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 133, 32} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bytes.bv8($M.0, $p4);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 133, 19} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.bv8.bv64($i5);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 133, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.bv8.bv32($i8);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 133, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 133, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv8($M.0, temp, $i13);
  call {:cexpr "temp"} boogie_si_record_bv8($i13);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 133, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 132, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 134, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  call {:cexpr "x"} boogie_si_record_bv64($i1);
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 245, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv32($M.0, $p0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 273, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v9($i1, $p0);
