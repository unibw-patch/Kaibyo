...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv7 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v7.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 53821));
...
const case7_mask: ref;
axiom (case7_mask == $sub.ref(0, 6348));
const idxg: ref;
axiom (idxg == $sub.ref(0, 7376));
const llvm.used: ref;
axiom (llvm.used == $sub.ref(0, 8408));
const {:count 16} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 9448));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 10480));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 11507));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 12545));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 13573));
const victim_function_v7: ref;
axiom (victim_function_v7 == $sub.ref(0, 14605));
procedure  victim_function_v7($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv32;
  ...
  var $i12: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 125, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v7:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 125, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 125, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.bv32($i1, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 125, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, case7_mask, $i2);
  call {:cexpr "case7_mask"} boogie_si_record_bv32($i2);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 127, 39} true;
  assume {:verifier.code 0} true;
  $i3 := $load.bv32($M.0, case7_mask);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 127, 37} true;
  assume {:verifier.code 0} true;
  $i4 := $and.bv32($i0, $i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 127, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.bv32.bv64($i4);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 127, 21} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(publicarray, $mul.ref(0, 64)), $mul.ref($bv2int.64($i5), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 127, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $load.bv32($M.0, $p6);
  call {:cexpr "toleak"} boogie_si_record_bv32($i7);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 128, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 128, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 129, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 15637));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 268, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v7($i1);
...
axiom (__VERIFIER_assume == $sub.ref(0, 16669));
...
axiom (__SMACK_code == $sub.ref(0, 17701));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 18733));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 19765));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 20797));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 21829));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 22861));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 23893));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 24925));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 25957));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 26989));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 28021));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 29053));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 30085));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 31117));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 32149));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 33181));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 34213));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 35245));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 36277));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 37309));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 38341));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 39373));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 40405));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 41437));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 42469));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 43501));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 44533));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 45565));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 46597));
...
axiom (__SMACK_decls == $sub.ref(0, 47629));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 48661));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 49693));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 50725));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 51757));
...
axiom (llvm.dbg.value == $sub.ref(0, 52789));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 53821));
...
$bb0:
  ...
  $M.0 := $store.bv32($M.0, case7_mask, $sub.bv32(0bv32, 1bv32));
  call {:cexpr "case7_mask"} boogie_si_record_bv32($sub.bv32(0bv32, 1bv32));
