...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -O2 -Dv8 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v8.o2.bpl
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i5 := $add.bv64($i0, 1bv64);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 121, 39} true;
  assume {:verifier.code 0} true;
  $i6 := (if ($i4 == 1bv1) then $i5 else 0bv64);
