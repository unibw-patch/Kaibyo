...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-pht.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv15 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-pht-v15.o0.bpl
...
axiom (victim_function_v15 == $sub.ref(0, 12435));
procedure  victim_function_v15($p0: ref)
{
  ...
  var $i15: bv8;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 227, 10} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 227, 10} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv64($M.0, $p0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 227, 15} true;
  assume {:verifier.code 0} true;
  $i2 := $load.bytes.bv32($M.0, publicarray_size);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 227, 15} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.bv32.bv64($i2);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 227, 13} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.bv64($i1, $i3);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 227, 10} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1bv1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 228, 44} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bytes.bv64($M.0, $p0);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 228, 32} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(publicarray, $mul.ref(0, 16)), $mul.ref($bv2int.64($i5), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 228, 32} true;
  assume {:verifier.code 0} true;
  $i7 := $load.bytes.bv8($M.0, $p6);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 228, 19} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.bv8.bv64($i7);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 228, 19} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i8), 1));
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 228, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 228, 16} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 228, 11} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 227, 10} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 229, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const llvm.dbg.declare: ref;
axiom (llvm.dbg.declare == $sub.ref(0, 13467));
...
$bb0:
  ...
  call {:cexpr "smack:ext:__VERIFIER_nondet_long"} boogie_si_record_bv64($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 244, 7} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv64($M.0, $p0, $i1);
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-pht.c", 291, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v15($p0);
