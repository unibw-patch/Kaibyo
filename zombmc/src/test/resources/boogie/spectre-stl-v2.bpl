...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv2 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v2.bpl
...
axiom (victim_function_v2 == $sub.ref(0, 13577));
procedure  victim_function_v2($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv32;
  ...
  var $i12: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 59, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v2:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 59, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 59, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.bv32($i1, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 59, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv32($i0, $i2);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 59, 8} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, idxg, $i3);
  call {:cexpr "idxg"} boogie_si_record_bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 62, 36} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, idxg);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 62, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $load.bv32($M.0, $p6);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 62, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 62, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 63, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 253, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v2($i1);
