...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv5 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v5.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 53825));
...
const case5_ptr: ref;
axiom (case5_ptr == $sub.ref(0, 6352));
const idxg: ref;
axiom (idxg == $sub.ref(0, 7380));
const llvm.used: ref;
axiom (llvm.used == $sub.ref(0, 8412));
const {:count 16} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 9452));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 10484));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 11511));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 12549));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 13577));
const victim_function_v5: ref;
axiom (victim_function_v5 == $sub.ref(0, 14609));
procedure  victim_function_v5($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv32;
  ...
  var $i12: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 99, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v5:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 99, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 99, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.bv32($i1, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 99, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv32($i0, $i2);
  call {:cexpr "ridx"} boogie_si_record_bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 101, 13} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.ref($M.0, case5_ptr, publicarray);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 103, 21} true;
  assume {:verifier.code 0} true;
  $p4 := $load.bytes.ref($M.0, case5_ptr);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 103, 21} true;
  assume {:verifier.code 0} true;
  $i5 := $zext.bv32.bv64($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 103, 21} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($p4, $mul.ref($bv2int.64($i5), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 103, 21} true;
  assume {:verifier.code 0} true;
  $i7 := $load.bytes.bv32($M.0, $p6);
  call {:cexpr "toleak"} boogie_si_record_bv32($i7);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 104, 11} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.bv32.bv64($i7);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 104, 11} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref(publicarray2, $mul.ref(0, 64)), $mul.ref($bv2int.64($i8), 4));
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 104, 11} true;
  assume {:verifier.code 0} true;
  $i10 := $load.bytes.bv32($M.0, $p9);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 104, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 105, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 15641));
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 262, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v5($i1);
...
axiom (__VERIFIER_assume == $sub.ref(0, 16673));
...
axiom (__SMACK_code == $sub.ref(0, 17705));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 18737));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 19769));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 20801));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 21833));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 22865));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 23897));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 24929));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 25961));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 26993));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 28025));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __SMACK_nondet_int: ref;
axiom (__SMACK_nondet_int == $sub.ref(0, 29057));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 30089));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 31121));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __VERIFIER_nondet_unsigned_int: ref;
axiom (__VERIFIER_nondet_unsigned_int == $sub.ref(0, 32153));
...
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 33185));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 34217));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 35249));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 36281));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 37313));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 38345));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 39377));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 40409));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 41441));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 42473));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 43505));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 44537));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 45569));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __VERIFIER_nondet_uint: ref;
axiom (__VERIFIER_nondet_uint == $sub.ref(0, 46601));
...
axiom (__SMACK_decls == $sub.ref(0, 47633));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 48665));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 49697));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 50729));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 51761));
...
axiom (llvm.dbg.value == $sub.ref(0, 52793));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 53825));
...
$bb0:
  ...
  $M.0 := $store.bytes.ref($M.0, case5_ptr, secretarray);
