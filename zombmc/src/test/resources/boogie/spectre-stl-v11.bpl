...
// via /usr/local/bin/smack /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/spectre-stl.c -t --no-memory-splitting --integer-encoding bit-vector -q --clang-options=-fms-extensions -Dzombmc  -Dv11 -bpl /Users/ponce/eclipse-workspace/zombmc/Dat3M/benchmarks/spectre/bpl/spectre-stl-v11.bpl
...
const case_11_load_value: ref;
axiom (case_11_load_value == $sub.ref(0, 13577));
procedure  case_11_load_value($i0: bv32)
  returns ($r: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  ...
  var $i6: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 195, 17} true;
  assume {:verifier.code 0} true;
  call {:cexpr "case_11_load_value:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 195, 17} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 195, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $sub.bv32($i1, 1bv32);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 195, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $and.bv32($i0, $i2);
  call {:cexpr "ridx"} boogie_si_record_bv32($i3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 196, 22} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 197, 3} true;
  assume {:verifier.code 0} true;
  $r := $i6;
  $exn := false;
  return;
...
axiom (victim_function_v11 == $sub.ref(0, 14609));
procedure  victim_function_v11($i0: bv32)
{
  ...
  var $i6: bv32;
$bb0:
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 200, 22} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v11:arg:idx"} boogie_si_record_bv32($i0);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 200, 22} true;
  assume {:verifier.code 0} true;
  call $i1 := case_11_load_value($i0);
  call {:cexpr "to_leak"} boogie_si_record_bv32($i1);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 203, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, $p3);
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 203, 8} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 204, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "benchmarks/spectre/spectre-stl.c", 280, 5} true;
  assume {:verifier.code 0} true;
