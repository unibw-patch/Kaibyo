...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv01 -bpl spectre_v01.bpl
...
axiom (victim_function_v01 == $sub.ref(0, 12625));
procedure  victim_function_v01($i0: i64)
{
  ...
  var $i15: i8;
$bb0:
  assume {:sourceloc "spectre.c", 28, 13} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $zext.i32.i64($i1);
  assume {:sourceloc "spectre.c", 28, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.i64($i0, $i2);
  assume {:sourceloc "spectre.c", 28, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "spectre.c", 29, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $zext.i8.i32($i5);
  assume {:sourceloc "spectre.c", 29, 34} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.i32($i6, 1);
  assume {:sourceloc "spectre.c", 29, 17} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  assume {:sourceloc "spectre.c", 29, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i8.i32($i10);
  assume {:sourceloc "spectre.c", 29, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 29, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:29:14: warning: over-approximating bitwise operation and;
  $i14 := $and.i32($i13, $i11);
  assume {:sourceloc "spectre.c", 29, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 30, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 28, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 31, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
