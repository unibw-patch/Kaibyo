...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv01 -fms-extensions -I../../include/ -bpl spectre_v01.bpl
...
axiom (victim_function_v01 == $sub.ref(0, 15762));
procedure  victim_function_v01($i0: i64)
{
  var $i1: i32;
  var $i2: i64;
  var $i3: i1;
...
$bb0:
  ...
  call {:cexpr "victim_function_v01:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 25, 13} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:sourceloc "spectre.c", 26, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:26:14: warning: over-approximating bitwise operation and;
  $i14 := $and.i32($i13, $i11);
  assume {:sourceloc "spectre.c", 26, 14} true;
  assume {:verifier.code 0} true;
