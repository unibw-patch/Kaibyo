...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv10 -fms-extensions -I../../include/ -bpl bv-spectre_v10.bpl --bit-precise
...
const victim_function_v10: ref;
axiom (victim_function_v10 == $sub.ref(0, 16580));
procedure  victim_function_v10($i0: bv32, $i1: bv32)
{
  var $i2: bv32;
  var $i3: bv1;
  var $i4: bv64;
  ...
  var $i10: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 131, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v10:arg:x"} boogie_si_record_bv32($i0);
  call {:cexpr "victim_function_v10:arg:k"} boogie_si_record_bv32($i1);
  assume {:sourceloc "spectre.c", 131, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $load.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 131, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv32($i0, $i2);
  assume {:sourceloc "spectre.c", 131, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "spectre.c", 132, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $load.bv32($M.0, $p5);
  assume {:sourceloc "spectre.c", 132, 23} true;
  assume {:verifier.code 0} true;
  $i7 := $eq.bv32($i6, $i1);
  assume {:sourceloc "spectre.c", 132, 13} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 136, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume ($i7 == 1bv1);
  assume {:sourceloc "spectre.c", 133, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.bv32($M.0, array2);
  assume {:sourceloc "spectre.c", 133, 18} true;
  assume {:verifier.code 0} true;
  $i9 := $load.bv32($M.0, temp);
  assume {:sourceloc "spectre.c", 133, 18} true;
  assume {:verifier.code 0} true;
  $i10 := $and.bv32($i9, $i8);
  assume {:sourceloc "spectre.c", 133, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, temp, $i10);
  call {:cexpr "temp"} boogie_si_record_bv32($i10);
  assume {:sourceloc "spectre.c", 134, 9} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "spectre.c", 132, 13} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "spectre.c", 135, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
const main: ref;
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 243, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v10($i0, $i1);
