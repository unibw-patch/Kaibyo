...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv11 -fms-extensions -I../../include/ -bpl bv-spectre_v11-opt.bpl --bit-precise
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i10 := $load.bytes.bv8($M.0, temp);
  assume {:sourceloc "spectre.c", 149, 20} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.bv8.bv32($i10);
  assume {:sourceloc "spectre.c", 149, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $load.bytes.bv8($M.0, $p9);
  assume {:sourceloc "spectre.c", 149, 27} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.bv8.bv32($i12);
  assume {:sourceloc "spectre.c", 149, 25} true;
  assume {:verifier.code 0} true;
  $i14 := $sub.bv32($i11, $i13);
  call {:cexpr "res"} boogie_si_record_bv32($i14);
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  $i15 := $load.bytes.bv32($M.0, temp);
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  $i16 := $and.bv32($i14, $i15);
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv32($M.0, temp, $i16);
  call {:cexpr "temp"} boogie_si_record_bv32($i16);
