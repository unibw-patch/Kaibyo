...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv15 -fms-extensions -I../../include/ -bpl bv-spectre_v15-opt.bpl --bit-precise
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i7 := $sext.bv32.bv64($i4);
  assume {:sourceloc "spectre.c", 207, 24} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref($bv2int.64($i7), 4));
  assume {:sourceloc "spectre.c", 207, 24} true;
  assume {:verifier.code 0} true;
  $i9 := $load.bv32($M.0, $p8);
