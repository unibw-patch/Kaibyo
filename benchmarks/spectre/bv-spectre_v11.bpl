...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv11 -fms-extensions -I../../include/ -bpl bv-spectre_v11.bpl --bit-precise
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 55796));
...
const array1_size: ref;
axiom (array1_size == $sub.ref(0, 1028));
const {:count 16} array1: ref;
axiom (array1 == $sub.ref(0, 2116));
const secret: ref;
axiom (secret == $sub.ref(0, 3148));
const .str: ref;
axiom (.str == $sub.ref(0, 4213));
const temp: ref;
axiom (temp == $sub.ref(0, 5241));
const {:count 256} array2: ref;
axiom (array2 == $sub.ref(0, 7289));
const array_size_mask: ref;
axiom (array_size_mask == $sub.ref(0, 8317));
const victim_function_v07.last_x: ref;
axiom (victim_function_v07.last_x == $sub.ref(0, 9345));
const {:count 16} .str.1.2: ref;
axiom (.str.1.2 == $sub.ref(0, 10385));
const {:count 14} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 11423));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 12455));
const {:count 3} .str.1.5: ref;
axiom (.str.1.5 == $sub.ref(0, 13482));
const {:count 14} .str.20: ref;
axiom (.str.20 == $sub.ref(0, 14520));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 15548));
const mymemcmp: ref;
axiom (mymemcmp == $sub.ref(0, 16580));
procedure  mymemcmp($p0: ref, $p1: ref, $i2: bv32)
  returns ($r: bv32)
{
  var $p3: ref;
  var $i4: bv32;
  ...
  var $i8: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 148, 10} true;
  assume {:verifier.code 0} true;
  call {:cexpr "mymemcmp:arg:count"} boogie_si_record_bv32($i2);
  assume {:sourceloc "spectre.c", 148, 10} true;
  assume {:verifier.code 0} true;
  $p3, $i4, $p5, $i6 := $p0, $i2, $p1, 0bv32;
  goto $bb1;
$bb1:
  assume {:sourceloc "spectre.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 148, 32} true;
  assume {:verifier.code 0} true;
  $i7 := $slt.bv32(0bv32, $i4);
  assume {:sourceloc "spectre.c", 148, 5} true;
  assume {:verifier.code 0} true;
  $i8 := $i6;
...
$bb2:
  assume ($i7 == 1bv1);
  assume {:sourceloc "spectre.c", 149, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $load.bv8($M.0, $p3);
  assume {:sourceloc "spectre.c", 149, 20} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.bv8.bv32($i9);
  assume {:sourceloc "spectre.c", 149, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.bv8($M.0, $p5);
  assume {:sourceloc "spectre.c", 149, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.bv8.bv32($i11);
  assume {:sourceloc "spectre.c", 149, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.bv32($i10, $i12);
  call {:cexpr "res"} boogie_si_record_bv32($i13);
  assume {:sourceloc "spectre.c", 149, 33} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.bv32($i13, 0bv32);
  assume {:sourceloc "spectre.c", 149, 13} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume {:sourceloc "spectre.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 153, 5} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $exn := false;
  return;
$bb5:
  assume ($i14 == 1bv1);
  assume {:sourceloc "spectre.c", 150, 13} true;
  assume {:verifier.code 0} true;
  $i8 := $i13;
  goto $bb4;
$bb6:
  assume !(($i14 == 1bv1));
  assume {:sourceloc "spectre.c", 152, 5} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "spectre.c", 148, 41} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p3, $mul.ref(1, 1));
  assume {:sourceloc "spectre.c", 148, 48} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p5, $mul.ref(1, 1));
  assume {:sourceloc "spectre.c", 148, 60} true;
  assume {:verifier.code 0} true;
  $i17 := $add.bv32($i4, $sub.bv32(0bv32, 1bv32));
  call {:cexpr "count"} boogie_si_record_bv32($i17);
  assume {:sourceloc "spectre.c", 148, 5} true;
  assume {:verifier.code 0} true;
  $p3, $i4, $p5, $i6 := $p15, $i17, $p16, $i13;
  goto $bb1;
}
const victim_function_v11: ref;
axiom (victim_function_v11 == $sub.ref(0, 17612));
procedure  victim_function_v11($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv1;
  var $i3: bv64;
  ...
  var $i12: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 156, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v11:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 156, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bytes.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 156, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 156, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "spectre.c", 157, 43} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.bv32.bv64($i0);
  assume {:sourceloc "spectre.c", 157, 43} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref($bv2int.64($i3), 4));
  assume {:sourceloc "spectre.c", 157, 43} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bytes.bv32($M.0, $p4);
  assume {:sourceloc "spectre.c", 157, 53} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.bv32($i5, 1bv32);
  assume {:sourceloc "spectre.c", 157, 40} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.bv32.bv64($i6);
  $p8 := $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref($bv2int.64($i7), 4));
  assume {:sourceloc "spectre.c", 157, 33} true;
  assume {:verifier.code 0} true;
  $p9 := $bitcast.ref.ref($p8);
  assume {:sourceloc "spectre.c", 157, 17} true;
  assume {:verifier.code 0} true;
  call $i10 := mymemcmp(temp, $p9, 1bv32);
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $load.bytes.bv32($M.0, temp);
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  $i12 := $and.bv32($i11, $i10);
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bytes.bv32($M.0, temp, $i12);
  call {:cexpr "temp"} boogie_si_record_bv32($i12);
  assume {:sourceloc "spectre.c", 158, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 156, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 159, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 18644));
...
$bb0:
  call $initialize();
  assume {:sourceloc "spectre.c", 213, 13} true;
  ...
  assume {:sourceloc "spectre.c", 214, 13} true;
  assume {:verifier.code 1} true;
  call $i1 := __VERIFIER_nondet_int();
  call {:cexpr "smack:ext:__VERIFIER_nondet_int"} boogie_si_record_bv32($i1);
  call {:cexpr "k"} boogie_si_record_bv32($i1);
  assume {:sourceloc "spectre.c", 246, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v11($i0);
  assume {:sourceloc "spectre.c", 260, 5} true;
  assume {:verifier.code 0} true;
  $r := 0bv32;
  $exn := false;
  return;
...
axiom (__VERIFIER_assume == $sub.ref(0, 19676));
...
axiom (__SMACK_code == $sub.ref(0, 20708));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.bv32($p0: ref, p.1: bv32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 21740));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 22772));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 23804));
procedure  __SMACK_nondet_char()
  returns ($r: bv8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 24836));
procedure  __SMACK_nondet_signed_char()
  returns ($r: bv8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 25868));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: bv8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 26900));
procedure  __SMACK_nondet_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 27932));
procedure  __SMACK_nondet_signed_short()
  returns ($r: bv16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 28964));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 29996));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: bv16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 31028));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: bv16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 32060));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 33092));
procedure  __SMACK_nondet_int()
  returns ($r: bv32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 34124));
procedure  __SMACK_nondet_signed_int()
  returns ($r: bv32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 35156));
procedure  __SMACK_nondet_unsigned()
  returns ($r: bv32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 36188));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: bv32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 37220));
procedure  __SMACK_nondet_long()
  returns ($r: bv64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 38252));
procedure  __SMACK_nondet_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 39284));
procedure  __SMACK_nondet_signed_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 40316));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 41348));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 42380));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: bv64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 43412));
procedure  __SMACK_nondet_long_long()
  returns ($r: bv64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 44444));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 45476));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: bv64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 46508));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 47540));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: bv64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 48572));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: bv64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 49604));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 50636));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 51668));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 52700));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 53732));
...
axiom (llvm.dbg.value == $sub.ref(0, 54764));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 55796));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.bytes.bv32($M.0, array1_size, 16bv32);
  call {:cexpr "array1_size"} boogie_si_record_bv32(16bv32);
  $M.0 := $store.bytes.bv32($M.0, array1, 1bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(1, 4)), 2bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(2, 4)), 3bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(3, 4)), 4bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(4, 4)), 5bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(5, 4)), 6bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(6, 4)), 7bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(7, 4)), 8bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(8, 4)), 9bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(9, 4)), 10bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(10, 4)), 11bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(11, 4)), 12bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(12, 4)), 13bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(13, 4)), 14bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(14, 4)), 15bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref(15, 4)), 16bv32);
  $M.0 := $store.bytes.ref($M.0, secret, .str);
  $M.0 := $store.bytes.bv32($M.0, temp, 0bv32);
  call {:cexpr "temp"} boogie_si_record_bv32(0bv32);
  $M.0 := $store.bytes.bv32($M.0, array2, 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(1, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(2, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(3, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(4, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(5, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(6, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(7, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(8, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(9, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(10, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(11, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(12, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(13, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(14, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(15, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(16, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(17, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(18, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(19, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(20, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(21, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(22, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(23, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(24, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(25, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(26, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(27, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(28, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(29, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(30, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(31, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(32, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(33, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(34, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(35, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(36, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(37, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(38, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(39, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(40, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(41, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(42, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(43, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(44, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(45, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(46, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(47, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(48, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(49, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(50, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(51, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(52, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(53, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(54, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(55, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(56, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(57, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(58, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(59, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(60, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(61, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(62, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(63, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(64, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(65, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(66, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(67, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(68, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(69, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(70, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(71, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(72, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(73, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(74, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(75, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(76, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(77, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(78, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(79, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(80, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(81, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(82, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(83, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(84, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(85, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(86, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(87, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(88, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(89, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(90, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(91, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(92, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(93, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(94, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(95, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(96, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(97, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(98, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(99, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(100, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(101, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(102, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(103, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(104, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(105, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(106, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(107, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(108, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(109, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(110, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(111, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(112, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(113, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(114, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(115, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(116, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(117, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(118, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(119, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(120, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(121, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(122, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(123, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(124, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(125, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(126, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(127, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(128, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(129, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(130, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(131, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(132, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(133, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(134, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(135, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(136, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(137, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(138, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(139, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(140, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(141, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(142, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(143, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(144, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(145, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(146, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(147, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(148, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(149, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(150, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(151, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(152, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(153, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(154, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(155, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(156, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(157, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(158, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(159, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(160, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(161, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(162, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(163, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(164, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(165, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(166, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(167, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(168, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(169, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(170, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(171, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(172, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(173, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(174, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(175, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(176, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(177, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(178, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(179, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(180, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(181, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(182, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(183, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(184, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(185, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(186, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(187, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(188, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(189, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(190, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(191, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(192, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(193, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(194, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(195, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(196, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(197, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(198, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(199, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(200, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(201, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(202, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(203, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(204, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(205, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(206, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(207, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(208, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(209, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(210, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(211, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(212, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(213, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(214, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(215, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(216, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(217, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(218, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(219, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(220, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(221, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(222, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(223, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(224, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(225, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(226, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(227, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(228, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(229, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(230, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(231, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(232, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(233, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(234, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(235, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(236, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(237, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(238, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(239, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(240, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(241, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(242, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(243, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(244, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(245, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(246, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(247, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(248, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(249, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(250, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(251, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(252, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(253, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(254, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref(255, 4)), 0bv32);
  $M.0 := $store.bytes.bv32($M.0, array_size_mask, 15bv32);
  call {:cexpr "array_size_mask"} boogie_si_record_bv32(15bv32);
  $M.0 := $store.bytes.bv32($M.0, victim_function_v07.last_x, 0bv32);
  call {:cexpr "victim_function_v07.last_x"} boogie_si_record_bv32(0bv32);
