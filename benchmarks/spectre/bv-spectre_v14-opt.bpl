...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv14 -fms-extensions -I../../include/ -bpl bv-spectre_v14-opt.bpl --bit-precise
