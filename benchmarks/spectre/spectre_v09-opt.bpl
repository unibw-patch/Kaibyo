...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv09 -fms-extensions -I../../include/ -bpl spectre_v09-opt.bpl
...
$bb0:
  ...
  $i2 := $sext.i32.i64($i1);
  call {:cexpr "k"} boogie_si_record_i64($i2);
