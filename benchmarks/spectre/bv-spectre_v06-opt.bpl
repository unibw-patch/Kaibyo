...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv06 -fms-extensions -I../../include/ -bpl bv-spectre_v06-opt.bpl --bit-precise
...
$bb0:
  ...
  $i2 := $load.bv32($M.0, array_size_mask);
