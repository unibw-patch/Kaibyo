...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv12 -fms-extensions -I../../include/ -bpl bv-spectre_v12.bpl --bit-precise
...
const victim_function_v12: ref;
axiom (victim_function_v12 == $sub.ref(0, 16580));
procedure  victim_function_v12($i0: bv32, $i1: bv32)
{
  var $i2: bv32;
  var $i3: bv32;
  var $i4: bv1;
  ...
  var $i14: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 167, 12} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v12:arg:x"} boogie_si_record_bv32($i0);
  call {:cexpr "victim_function_v12:arg:y"} boogie_si_record_bv32($i1);
  assume {:sourceloc "spectre.c", 167, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $add.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 167, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $load.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 167, 17} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.bv32($i2, $i3);
  assume {:sourceloc "spectre.c", 167, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1bv1);
  assume {:sourceloc "spectre.c", 168, 33} true;
  assume {:verifier.code 0} true;
  $i5 := $add.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 168, 24} true;
  assume {:verifier.code 0} true;
  $i6 := $sext.bv32.bv64($i5);
  assume {:sourceloc "spectre.c", 168, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $load.bv32($M.0, $p7);
  assume {:sourceloc "spectre.c", 168, 38} true;
  assume {:verifier.code 0} true;
  $i9 := $mul.bv32($i8, 1bv32);
  assume {:sourceloc "spectre.c", 168, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 168, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 169, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 167, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 170, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 249, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v12($i0, $i1);
