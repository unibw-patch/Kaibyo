...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O2 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv13 -bpl spectre_v13-opt.bpl
