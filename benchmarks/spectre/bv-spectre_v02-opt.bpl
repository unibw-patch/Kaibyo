...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv02 -fms-extensions -I../../include/ -bpl bv-spectre_v02-opt.bpl --bit-precise
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i6 := $load.bv32($M.0, $p5);
  call {:cexpr "k"} boogie_si_record_bv32($i6);
