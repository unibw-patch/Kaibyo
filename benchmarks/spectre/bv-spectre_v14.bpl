...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv14 -fms-extensions -I../../include/ -bpl bv-spectre_v14.bpl --bit-precise
...
const victim_function_v14: ref;
axiom (victim_function_v14 == $sub.ref(0, 16580));
procedure  victim_function_v14($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv1;
  var $i3: bv32;
  ...
  var $i12: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 195, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v14:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 195, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 195, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 195, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "spectre.c", 196, 33} true;
  assume {:verifier.code 0} true;
  $i3 := $xor.bv32($i0, 255bv32);
  assume {:sourceloc "spectre.c", 196, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.bv32.bv64($i3);
  assume {:sourceloc "spectre.c", 196, 24} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref($bv2int.64($i4), 4));
  assume {:sourceloc "spectre.c", 196, 24} true;
  assume {:verifier.code 0} true;
  $i6 := $load.bv32($M.0, $p5);
  assume {:sourceloc "spectre.c", 196, 40} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.bv32($i6, 1bv32);
  assume {:sourceloc "spectre.c", 196, 17} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.bv32.bv64($i7);
  assume {:sourceloc "spectre.c", 196, 17} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref($bv2int.64($i8), 4));
  assume {:sourceloc "spectre.c", 196, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $load.bv32($M.0, $p9);
  assume {:sourceloc "spectre.c", 196, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $load.bv32($M.0, temp);
  assume {:sourceloc "spectre.c", 196, 14} true;
  assume {:verifier.code 0} true;
  $i12 := $and.bv32($i11, $i10);
  assume {:sourceloc "spectre.c", 196, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, temp, $i12);
  call {:cexpr "temp"} boogie_si_record_bv32($i12);
  assume {:sourceloc "spectre.c", 197, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 195, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 198, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 255, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v14($i0);
