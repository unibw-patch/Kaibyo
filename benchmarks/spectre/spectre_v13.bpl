...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv13 -fms-extensions -I../../include/ -bpl spectre_v13.bpl
...
const is_x_safe: ref;
axiom (is_x_safe == $sub.ref(0, 15762));
procedure  is_x_safe($i0: i64)
  returns ($r: i32)
{
  var $i1: i32;
  var $i2: i64;
...
$bb0:
  ...
  call {:cexpr "is_x_safe:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 178, 13} true;
  assume {:verifier.code 0} true;
...
axiom (victim_function_v13 == $sub.ref(0, 16794));
procedure  victim_function_v13($i0: i64)
{
  var $i1: i32;
  var $i2: i1;
  var $p3: ref;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v13:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 184, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:sourceloc "spectre.c", 185, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:185:14: warning: over-approximating bitwise operation and;
  $i13 := $and.i32($i12, $i10);
  assume {:sourceloc "spectre.c", 185, 14} true;
  assume {:verifier.code 0} true;
