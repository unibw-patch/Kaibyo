...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv13 -bpl spectre_v13.bpl
...
const is_x_safe: ref;
axiom (is_x_safe == $sub.ref(0, 12625));
  ...
  returns ($r: i32)
{
  ...
  var $i4: i32;
$bb0:
  assume {:sourceloc "spectre.c", 181, 13} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $zext.i32.i64($i1);
  assume {:sourceloc "spectre.c", 181, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.i64($i0, $i2);
  assume {:sourceloc "spectre.c", 181, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "spectre.c", 182, 9} true;
  assume {:verifier.code 0} true;
  $i4 := 1;
  goto $bb3;
$bb2:
  assume !(($i3 == 1));
  assume {:sourceloc "spectre.c", 184, 5} true;
  assume {:verifier.code 0} true;
  $i4 := 0;
  goto $bb3;
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 185, 1} true;
  assume {:verifier.code 0} true;
  $r := $i4;
  $exn := false;
  return;
...
axiom (victim_function_v13 == $sub.ref(0, 13657));
procedure  victim_function_v13($i0: i64)
{
  ...
  var $i14: i8;
$bb0:
  assume {:sourceloc "spectre.c", 187, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "spectre.c", 188, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i5 := $zext.i8.i32($i4);
  assume {:sourceloc "spectre.c", 188, 34} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32($i5, 1);
  assume {:sourceloc "spectre.c", 188, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  assume {:sourceloc "spectre.c", 188, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i10 := $zext.i8.i32($i9);
  assume {:sourceloc "spectre.c", 188, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 188, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:188:14: warning: over-approximating bitwise operation and;
  $i13 := $and.i32($i12, $i10);
  assume {:sourceloc "spectre.c", 188, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 189, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 187, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 190, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
