...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O2 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv05 -bpl spectre_v05-opt.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 49777));
...
axiom (llvm.dbg.value == $sub.ref(0, 12625));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const main: ref;
axiom (main == $sub.ref(0, 13657));
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 74, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 74, 14} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i32.i64($i3);
  assume {:sourceloc "spectre.c", 74, 12} true;
  assume {:verifier.code 0} true;
  $i5 := $ugt.i64($i4, $i1);
  assume {:sourceloc "spectre.c", 74, 10} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:sourceloc "spectre.c", 75, 29} true;
  assume {:verifier.code 0} true;
  $i7 := $sgt.i32($i6, $sub.i32(0, 1));
  assume {:sourceloc "spectre.c", 75, 11} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume ($i7 == 1);
  assume {:sourceloc "spectre.c", 76, 21} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, temp);
  assume {:sourceloc "spectre.c", 75, 11} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 75, 11} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:75:11: warning: over-approximating bitwise operation and;
  $i10 := $and.i32($i0, 3);
  assume {:sourceloc "spectre.c", 75, 11} true;
  assume {:verifier.code 0} true;
  $i11 := $eq.i32($i10, 0);
...
$bb8:
  ...
  goto $bb9;
$bb9:
  assume {:sourceloc "spectre.c", 76, 31} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 76, 31} true;
  assume {:verifier.code 0} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i21 := $load.i8($M.0, $p20);
  assume {:sourceloc "spectre.c", 76, 24} true;
  assume {:verifier.code 0} true;
  $i22 := $zext.i8.i64($i21);
  assume {:sourceloc "spectre.c", 76, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 76, 21} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:76:21: warning: over-approximating bitwise operation and;
  $i25 := $and.i8($i24, $i17);
  assume {:sourceloc "spectre.c", 0, 0} true;
  assume {:verifier.code 0} true;
...
axiom (__VERIFIER_assume == $sub.ref(0, 14689));
...
axiom (__SMACK_code == $sub.ref(0, 15721));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 16753));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 17785));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 18817));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 19849));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 20881));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 21913));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 22945));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 23977));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 25009));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 26041));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 27073));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 28105));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 29137));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 30169));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 31201));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 32233));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 33265));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 34297));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 35329));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 36361));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 37393));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 38425));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 39457));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 40489));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 41521));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 42553));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 43585));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 44617));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 45649));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 46681));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 47713));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 48745));
...
axiom (__SMACK_static_init == $sub.ref(0, 49777));
