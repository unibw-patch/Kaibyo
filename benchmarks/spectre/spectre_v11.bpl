...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv11 -fms-extensions -I../../include/ -bpl spectre_v11.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 54978));
...
axiom (array1 == $sub.ref(0, 2068));
const secret: ref;
axiom (secret == $sub.ref(0, 3100));
const .str: ref;
axiom (.str == $sub.ref(0, 4165));
const temp: ref;
axiom (temp == $sub.ref(0, 5190));
const {:count 256} array2: ref;
axiom (array2 == $sub.ref(0, 6470));
const array_size_mask: ref;
axiom (array_size_mask == $sub.ref(0, 7495));
const victim_function_v07.last_x: ref;
axiom (victim_function_v07.last_x == $sub.ref(0, 8527));
const {:count 16} .str.1.2: ref;
axiom (.str.1.2 == $sub.ref(0, 9567));
const {:count 14} .str.2: ref;
axiom (.str.2 == $sub.ref(0, 10605));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 11637));
const {:count 3} .str.1.5: ref;
axiom (.str.1.5 == $sub.ref(0, 12664));
const {:count 14} .str.20: ref;
axiom (.str.20 == $sub.ref(0, 13702));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 14730));
const mymemcmp: ref;
axiom (mymemcmp == $sub.ref(0, 15762));
procedure  mymemcmp($p0: ref, $p1: ref, $i2: i64)
  returns ($r: i32)
{
  var $p3: ref;
  var $i4: i64;
...
$bb0:
  ...
  call {:cexpr "mymemcmp:arg:count"} boogie_si_record_i64($i2);
  assume {:sourceloc "spectre.c", 148, 10} true;
  assume {:verifier.code 0} true;
  $p3, $i4, $p5, $i6 := $p0, $i2, $p1, 0;
  goto $bb1;
$bb1:
...
$bb2:
  ...
  assume {:verifier.code 0} true;
  $i13 := $sub.i32($i10, $i12);
  call {:cexpr "res"} boogie_si_record_i32($i13);
...
$bb7:
  ...
  assume {:verifier.code 0} true;
  $i17 := $add.i64($i4, $sub.i64(0, 1));
  call {:cexpr "count"} boogie_si_record_i64($i17);
  assume {:sourceloc "spectre.c", 148, 5} true;
  assume {:verifier.code 0} true;
...
axiom (victim_function_v11 == $sub.ref(0, 16794));
procedure  victim_function_v11($i0: i64)
{
  var $i1: i32;
  var $i2: i64;
  var $i3: i1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v11:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 156, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 156, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i32.i64($i1);
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i0, 1));
  assume {:sourceloc "spectre.c", 157, 43} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, $p4);
  assume {:sourceloc "spectre.c", 157, 43} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  $p9 := $add.ref($add.ref(array2, $mul.ref(0, 256)), $mul.ref($i8, 1));
  assume {:sourceloc "spectre.c", 157, 17} true;
  assume {:verifier.code 0} true;
  call $i10 := mymemcmp(temp, $p9, 1);
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, temp);
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i8.i32($i11);
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:157:14: warning: over-approximating bitwise operation and;
  $i13 := $and.i32($i12, $i10);
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i14);
  call {:cexpr "temp"} boogie_si_record_i8($i14);
...
$bb0:
  call $initialize();
  assume {:sourceloc "spectre.c", 213, 16} true;
  ...
  assume {:verifier.code 0} true;
  $i1 := $sext.i32.i64($i0);
  call {:cexpr "x"} boogie_si_record_i64($i1);
  assume {:sourceloc "spectre.c", 214, 16} true;
  assume {:verifier.code 1} true;
...
axiom (__VERIFIER_assume == $sub.ref(0, 18858));
...
axiom (__SMACK_code == $sub.ref(0, 19890));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 20922));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 21954));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 22986));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 24018));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 25050));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 26082));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 27114));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 28146));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 29178));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 30210));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 31242));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 32274));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 33306));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 34338));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 35370));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 36402));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 37434));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 38466));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 39498));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 40530));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 41562));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 42594));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 43626));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 44658));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 45690));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 46722));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 47754));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 48786));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 49818));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 50850));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 51882));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 52914));
...
axiom (llvm.dbg.value == $sub.ref(0, 53946));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 54978));
procedure  __SMACK_static_init()
{
$bb0:
  $M.0 := $store.i32($M.0, array1_size, 16);
  call {:cexpr "array1_size"} boogie_si_record_i32(16);
  $M.0 := $store.i8($M.0, array1, 1);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(1, 1)), 2);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(2, 1)), 3);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(3, 1)), 4);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(4, 1)), 5);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(5, 1)), 6);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(6, 1)), 7);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(7, 1)), 8);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(8, 1)), 9);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(9, 1)), 10);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref(10, 1)), 11);
  $M.0 := $store.i8($M.0, $add.ref($add.ref(