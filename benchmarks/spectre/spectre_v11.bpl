...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv11 -bpl spectre_v11.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 51841));
...
const temp: ref;
axiom (temp == $sub.ref(0, 3093));
const {:count 256} array2: ref;
axiom (array2 == $sub.ref(0, 4373));
const array_size_mask: ref;
axiom (array_size_mask == $sub.ref(0, 5398));
const victim_function_v07.last_x: ref;
axiom (victim_function_v07.last_x == $sub.ref(0, 6430));
const {:count 14} .str.1: ref;
axiom (.str.1 == $sub.ref(0, 7468));
const env_value_str: ref;
axiom (env_value_str == $sub.ref(0, 8500));
const {:count 3} .str.1.3: ref;
axiom (.str.1.3 == $sub.ref(0, 9527));
const {:count 14} .str.19: ref;
axiom (.str.19 == $sub.ref(0, 10565));
const errno_global: ref;
axiom (errno_global == $sub.ref(0, 11593));
const mymemcmp: ref;
axiom (mymemcmp == $sub.ref(0, 12625));
  ...
  returns ($r: i32)
{
  ...
  var $i8: i32;
$bb0:
  assume {:sourceloc "spectre.c", 151, 10} true;
...
$bb1:
  ...
  assume {:sourceloc "spectre.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 151, 32} true;
  assume {:verifier.code 0} true;
  $i7 := $ult.i64(0, $i4);
  assume {:sourceloc "spectre.c", 151, 5} true;
  assume {:verifier.code 0} true;
  $i8 := $i6;
...
$bb2:
  assume ($i7 == 1);
  assume {:sourceloc "spectre.c", 152, 20} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, $p3);
  assume {:sourceloc "spectre.c", 152, 20} true;
  assume {:verifier.code 0} true;
  $i10 := $zext.i8.i32($i9);
  assume {:sourceloc "spectre.c", 152, 27} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, $p5);
  assume {:sourceloc "spectre.c", 152, 27} true;
  assume {:verifier.code 0} true;
  $i12 := $zext.i8.i32($i11);
  assume {:sourceloc "spectre.c", 152, 25} true;
  assume {:verifier.code 0} true;
  $i13 := $sub.i32($i10, $i12);
  call {:cexpr "res"} boogie_si_record_i32($i13);
  assume {:sourceloc "spectre.c", 152, 33} true;
  assume {:verifier.code 0} true;
  $i14 := $ne.i32($i13, 0);
  assume {:sourceloc "spectre.c", 152, 13} true;
  assume {:verifier.code 0} true;
...
$bb4:
  assume {:sourceloc "spectre.c", 0, 0} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 156, 5} true;
  assume {:verifier.code 0} true;
  $r := $i8;
  $exn := false;
  return;
$bb5:
  assume ($i14 == 1);
  assume {:sourceloc "spectre.c", 153, 13} true;
  assume {:verifier.code 0} true;
  $i8 := $i13;
  goto $bb4;
$bb6:
  assume !(($i14 == 1));
  assume {:sourceloc "spectre.c", 155, 5} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb7:
  assume {:sourceloc "spectre.c", 151, 41} true;
  assume {:verifier.code 0} true;
  $p15 := $add.ref($p3, $mul.ref(1, 1));
  assume {:sourceloc "spectre.c", 151, 48} true;
  assume {:verifier.code 0} true;
  $p16 := $add.ref($p5, $mul.ref(1, 1));
  assume {:sourceloc "spectre.c", 151, 60} true;
  assume {:verifier.code 0} true;
...
axiom (victim_function_v11 == $sub.ref(0, 13657));
procedure  victim_function_v11($i0: i64)
{
  ...
  var $i14: i8;
$bb0:
  assume {:sourceloc "spectre.c", 159, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $zext.i32.i64($i1);
  assume {:sourceloc "spectre.c", 159, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.i64($i0, $i2);
  assume {:sourceloc "spectre.c", 159, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "spectre.c", 160, 43} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $zext.i8.i32($i5);
  assume {:sourceloc "spectre.c", 160, 53} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.i32($i6, 1);
  assume {:sourceloc "spectre.c", 160, 40} true;
  assume {:verifier.code 0} true;
  $i8 := $sext.i32.i64($i7);
  $p9 := $add.ref($add.ref(array2, $mul.ref(0, 256)), $mul.ref($i8, 1));
  assume {:sourceloc "spectre.c", 160, 17} true;
  assume {:verifier.code 0} true;
  call $i10 := mymemcmp(temp, $p9, 1);
  assume {:sourceloc "spectre.c", 160, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 160, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:160:14: warning: over-approximating bitwise operation and;
  $i13 := $and.i32($i12, $i10);
  assume {:sourceloc "spectre.c", 160, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 161, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 159, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 162, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const main: ref;
axiom (main == $sub.ref(0, 14689));
...
$bb0:
  call $initialize();
  assume {:sourceloc "spectre.c", 216, 16} true;
  ...
  assume {:sourceloc "spectre.c", 217, 16} true;
  assume {:verifier.code 1} true;
  ...
  assume {:sourceloc "spectre.c", 263, 5} true;
  assume {:verifier.code 0} true;
  $r := 0;
  $exn := false;
  return;
...
axiom (__VERIFIER_assume == $sub.ref(0, 15721));
...
axiom (__SMACK_code == $sub.ref(0, 16753));
procedure  __SMACK_code.ref($p0: ref);
procedure  __SMACK_code.ref.i32($p0: ref, p.1: i32);
const __SMACK_dummy: ref;
axiom (__SMACK_dummy == $sub.ref(0, 17785));
...
axiom (__SMACK_check_overflow == $sub.ref(0, 18817));
...
axiom (__SMACK_nondet_char == $sub.ref(0, 19849));
procedure  __SMACK_nondet_char()
  returns ($r: i8);
const __SMACK_nondet_signed_char: ref;
axiom (__SMACK_nondet_signed_char == $sub.ref(0, 20881));
procedure  __SMACK_nondet_signed_char()
  returns ($r: i8);
const __SMACK_nondet_unsigned_char: ref;
axiom (__SMACK_nondet_unsigned_char == $sub.ref(0, 21913));
procedure  __SMACK_nondet_unsigned_char()
  returns ($r: i8);
const __SMACK_nondet_short: ref;
axiom (__SMACK_nondet_short == $sub.ref(0, 22945));
procedure  __SMACK_nondet_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short: ref;
axiom (__SMACK_nondet_signed_short == $sub.ref(0, 23977));
procedure  __SMACK_nondet_signed_short()
  returns ($r: i16);
const __SMACK_nondet_signed_short_int: ref;
axiom (__SMACK_nondet_signed_short_int == $sub.ref(0, 25009));
procedure  __SMACK_nondet_signed_short_int()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short: ref;
axiom (__SMACK_nondet_unsigned_short == $sub.ref(0, 26041));
procedure  __SMACK_nondet_unsigned_short()
  returns ($r: i16);
const __SMACK_nondet_unsigned_short_int: ref;
axiom (__SMACK_nondet_unsigned_short_int == $sub.ref(0, 27073));
procedure  __SMACK_nondet_unsigned_short_int()
  returns ($r: i16);
const __VERIFIER_nondet_int: ref;
axiom (__VERIFIER_nondet_int == $sub.ref(0, 28105));
...
axiom (__SMACK_nondet_int == $sub.ref(0, 29137));
procedure  __SMACK_nondet_int()
  returns ($r: i32);
const __SMACK_nondet_signed_int: ref;
axiom (__SMACK_nondet_signed_int == $sub.ref(0, 30169));
procedure  __SMACK_nondet_signed_int()
  returns ($r: i32);
const __SMACK_nondet_unsigned: ref;
axiom (__SMACK_nondet_unsigned == $sub.ref(0, 31201));
procedure  __SMACK_nondet_unsigned()
  returns ($r: i32);
const __SMACK_nondet_unsigned_int: ref;
axiom (__SMACK_nondet_unsigned_int == $sub.ref(0, 32233));
procedure  __SMACK_nondet_unsigned_int()
  returns ($r: i32);
const __SMACK_nondet_long: ref;
axiom (__SMACK_nondet_long == $sub.ref(0, 33265));
procedure  __SMACK_nondet_long()
  returns ($r: i64);
const __SMACK_nondet_long_int: ref;
axiom (__SMACK_nondet_long_int == $sub.ref(0, 34297));
procedure  __SMACK_nondet_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long: ref;
axiom (__SMACK_nondet_signed_long == $sub.ref(0, 35329));
procedure  __SMACK_nondet_signed_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_int: ref;
axiom (__SMACK_nondet_signed_long_int == $sub.ref(0, 36361));
procedure  __SMACK_nondet_signed_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long: ref;
axiom (__SMACK_nondet_unsigned_long == $sub.ref(0, 37393));
procedure  __SMACK_nondet_unsigned_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_int == $sub.ref(0, 38425));
procedure  __SMACK_nondet_unsigned_long_int()
  returns ($r: i64);
const __SMACK_nondet_long_long: ref;
axiom (__SMACK_nondet_long_long == $sub.ref(0, 39457));
procedure  __SMACK_nondet_long_long()
  returns ($r: i64);
const __SMACK_nondet_long_long_int: ref;
axiom (__SMACK_nondet_long_long_int == $sub.ref(0, 40489));
procedure  __SMACK_nondet_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long: ref;
axiom (__SMACK_nondet_signed_long_long == $sub.ref(0, 41521));
procedure  __SMACK_nondet_signed_long_long()
  returns ($r: i64);
const __SMACK_nondet_signed_long_long_int: ref;
axiom (__SMACK_nondet_signed_long_long_int == $sub.ref(0, 42553));
procedure  __SMACK_nondet_signed_long_long_int()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long: ref;
axiom (__SMACK_nondet_unsigned_long_long == $sub.ref(0, 43585));
procedure  __SMACK_nondet_unsigned_long_long()
  returns ($r: i64);
const __SMACK_nondet_unsigned_long_long_int: ref;
axiom (__SMACK_nondet_unsigned_long_long_int == $sub.ref(0, 44617));
procedure  __SMACK_nondet_unsigned_long_long_int()
  returns ($r: i64);
const __SMACK_decls: ref;
axiom (__SMACK_decls == $sub.ref(0, 45649));
type $mop;
...
axiom (__SMACK_top_decl == $sub.ref(0, 46681));
procedure  __SMACK_top_decl.ref($p0: ref);
const __SMACK_init_func_memory_model: ref;
axiom (__SMACK_init_func_memory_model == $sub.ref(0, 47713));
...
axiom (__VERIFIER_atomic_begin == $sub.ref(0, 48745));
...
axiom (__VERIFIER_atomic_end == $sub.ref(0, 49777));
...
axiom (llvm.dbg.value == $sub.ref(0, 50809));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 51841));
