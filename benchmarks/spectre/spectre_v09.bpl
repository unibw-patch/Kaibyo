...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv09 -fms-extensions -I../../include/ -bpl spectre_v09.bpl
...
axiom (victim_function_v09 == $sub.ref(0, 15762));
procedure  victim_function_v09($i0: i64, $p1: ref)
{
  var $i2: i32;
  var $i3: i1;
  var $p4: ref;
...
$bb0:
  ...
  call {:cexpr "victim_function_v09:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 117, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, $p1);
  assume {:sourceloc "spectre.c", 117, 9} true;
...
$bb1:
  ...
  assume {:sourceloc "spectre.c", 118, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:118:14: warning: over-approximating bitwise operation and;
  $i14 := $and.i32($i13, $i11);
  assume {:sourceloc "spectre.c", 118, 14} true;
  assume {:verifier.code 0} true;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call victim_function_v09($i1, $p4);
