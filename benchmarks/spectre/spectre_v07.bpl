...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv07 -fms-extensions -I../../include/ -bpl spectre_v07.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 53946));
...
axiom (victim_function_v07 == $sub.ref(0, 15762));
procedure  victim_function_v07($i0: i64)
{
  var $i1: i64;
  var $i2: i1;
  var $p3: ref;
...
$bb0:
  ...
  call {:cexpr "victim_function_v07:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 96, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i64($M.0, victim_function_v07.last_x);
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i0, 1));
  assume {:sourceloc "spectre.c", 97, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $load.i8($M.0, $p3);
  assume {:sourceloc "spectre.c", 97, 24} true;
  ...
  assume {:sourceloc "spectre.c", 97, 17} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref(array2, $mul.ref(0, 256)), $mul.ref($i7, 1));
  assume {:sourceloc "spectre.c", 97, 17} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, $p8);
  assume {:sourceloc "spectre.c", 97, 17} true;
  ...
  assume {:sourceloc "spectre.c", 97, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:97:14: warning: over-approximating bitwise operation and;
  $i13 := $and.i32($i12, $i10);
  assume {:sourceloc "spectre.c", 97, 14} true;
  assume {:verifier.code 0} true;
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, victim_function_v07.last_x, $i0);
  call {:cexpr "victim_function_v07.last_x"} boogie_si_record_i64($i0);
...
axiom (llvm.dbg.value == $sub.ref(0, 52914));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 53946));
