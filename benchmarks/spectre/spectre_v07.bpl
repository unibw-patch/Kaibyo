...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv07 -bpl spectre_v07.bpl
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 50809));
...
axiom (victim_function_v07 == $sub.ref(0, 12625));
procedure  victim_function_v07($i0: i64)
{
  ...
  var $i17: i1;
$bb0:
  assume {:sourceloc "spectre.c", 99, 14} true;
...
$bb1:
  assume ($i2 == 1);
  assume {:sourceloc "spectre.c", 100, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i5 := $zext.i8.i32($i4);
  assume {:sourceloc "spectre.c", 100, 34} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.i32($i5, 1);
  assume {:sourceloc "spectre.c", 100, 17} true;
  assume {:verifier.code 0} true;
  $i7 := $sext.i32.i64($i6);
  assume {:sourceloc "spectre.c", 100, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i10 := $zext.i8.i32($i9);
  assume {:sourceloc "spectre.c", 100, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 100, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:100:14: warning: over-approximating bitwise operation and;
  $i13 := $and.i32($i12, $i10);
  assume {:sourceloc "spectre.c", 100, 14} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 102, 13} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 102, 13} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i32.i64($i15);
  assume {:sourceloc "spectre.c", 102, 11} true;
  assume {:verifier.code 0} true;
  $i17 := $ult.i64($i0, $i16);
  assume {:sourceloc "spectre.c", 102, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i17} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i17 == 1);
  assume {:sourceloc "spectre.c", 103, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, victim_function_v07.last_x, $i0);
  call {:cexpr "victim_function_v07.last_x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 104, 5} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "spectre.c", 102, 9} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "spectre.c", 105, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
axiom (llvm.dbg.value == $sub.ref(0, 49777));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 50809));
