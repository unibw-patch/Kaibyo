...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv04 -fms-extensions -I../../include/ -bpl spectre_v04.bpl
...
axiom (victim_function_v04 == $sub.ref(0, 15762));
procedure  victim_function_v04($i0: i64)
{
  var $i1: i32;
  var $i2: i64;
  var $i3: i1;
...
$bb0:
  ...
  call {:cexpr "victim_function_v04:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 59, 13} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:60:33: warning: over-approximating bitwise operation shl;
  $i4 := $shl.i64($i0, 1);
  ...
  assume {:sourceloc "spectre.c", 60, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:60:14: warning: over-approximating bitwise operation and;
  $i15 := $and.i32($i14, $i12);
  assume {:sourceloc "spectre.c", 60, 14} true;
  assume {:verifier.code 0} true;
