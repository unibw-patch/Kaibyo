...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv12 -fms-extensions -I../../include/ -bpl spectre_v12-opt.bpl
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i4, 1));
  assume {:sourceloc "spectre.c", 168, 24} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, $p8);
