...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv07 -fms-extensions -I../../include/ -bpl spectre_v07-opt.bpl
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i3 := $load.i64($M.0, victim_function_v07.last_x);
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i1, 1));
  assume {:sourceloc "spectre.c", 97, 24} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, $p5);
  ...
  assume {:sourceloc "spectre.c", 97, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i11);
  call {:cexpr "temp"} boogie_si_record_i8($i11);
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i64($M.0, victim_function_v07.last_x, $i1);
  call {:cexpr "victim_function_v07.last_x"} boogie_si_record_i64($i1);
