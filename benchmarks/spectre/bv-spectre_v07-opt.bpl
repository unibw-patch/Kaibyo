...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv07 -fms-extensions -I../../include/ -bpl bv-spectre_v07-opt.bpl --bit-precise
...
$bb0:
  ...
  $i2 := $load.bv32($M.0, victim_function_v07.last_x);
