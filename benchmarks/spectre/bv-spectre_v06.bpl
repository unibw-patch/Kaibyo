...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv06 -fms-extensions -I../../include/ -bpl bv-spectre_v06.bpl --bit-precise
...
const victim_function_v06: ref;
axiom (victim_function_v06 == $sub.ref(0, 16580));
procedure  victim_function_v06($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv1;
  ...
  var $i12: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 84, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v06:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 84, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array_size_mask);
  assume {:sourceloc "spectre.c", 84, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $and.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 84, 31} true;
  assume {:verifier.code 0} true;
  $i3 := $eq.bv32($i2, $i0);
  assume {:sourceloc "spectre.c", 84, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "spectre.c", 85, 24} true;
  assume {:verifier.code 0} true;
  $i4 := $sext.bv32.bv64($i0);
  assume {:sourceloc "spectre.c", 85, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $load.bv32($M.0, $p5);
  assume {:sourceloc "spectre.c", 85, 34} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.bv32($i6, 1bv32);
  assume {:sourceloc "spectre.c", 85, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 85, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 86, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 84, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 87, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 231, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v06($i0);
