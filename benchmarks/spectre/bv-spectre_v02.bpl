...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv02 -fms-extensions -I../../include/ -bpl bv-spectre_v02.bpl --bit-precise
...
const leakByteLocalFunction: ref;
axiom (leakByteLocalFunction == $sub.ref(0, 16580));
procedure  leakByteLocalFunction($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv64;
  var $p3: ref;
  ...
  var $i6: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 33, 55} true;
  assume {:verifier.code 0} true;
  call {:cexpr "leakByteLocalFunction:arg:k"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 33, 55} true;
  assume {:verifier.code 0} true;
  $i1 := $mul.bv32($i0, 1bv32);
  assume {:sourceloc "spectre.c", 33, 45} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, $p3);
  assume {:sourceloc "spectre.c", 33, 42} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 33, 64} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const victim_function_v02: ref;
axiom (victim_function_v02 == $sub.ref(0, 17612));
procedure  victim_function_v02($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv1;
  var $i3: bv64;
  ...
  var $i5: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 35, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v02:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 35, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 35, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 35, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "spectre.c", 36, 31} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i5 := $load.bv32($M.0, $p4);
  assume {:sourceloc "spectre.c", 36, 9} true;
  assume {:verifier.code 0} true;
  call leakByteLocalFunction($i5);
  assume {:sourceloc "spectre.c", 37, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 35, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 38, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 219, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v02($i0);
