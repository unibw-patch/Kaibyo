...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv10 -bpl spectre_v10.bpl
...
axiom (victim_function_v10 == $sub.ref(0, 12625));
procedure  victim_function_v10($i0: i64, $i1: i8)
{
  ...
  var $i15: i8;
$bb0:
  assume {:sourceloc "spectre.c", 134, 13} true;
  ...
  assume {:verifier.code 0} true;
  $i3 := $zext.i32.i64($i2);
  assume {:sourceloc "spectre.c", 134, 11} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.i64($i0, $i3);
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "spectre.c", 135, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $zext.i8.i32($i6);
  assume {:sourceloc "spectre.c", 135, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i8.i32($i1);
  assume {:sourceloc "spectre.c", 135, 23} true;
  assume {:verifier.code 0} true;
  $i9 := $eq.i32($i7, $i8);
  assume {:sourceloc "spectre.c", 135, 13} true;
  assume {:verifier.code 0} true;
...
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 139, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
  assume ($i9 == 1);
  assume {:sourceloc "spectre.c", 136, 21} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, array2);
  assume {:sourceloc "spectre.c", 136, 21} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i8.i32($i10);
  assume {:sourceloc "spectre.c", 136, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 136, 18} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:136:18: warning: over-approximating bitwise operation and;
  $i14 := $and.i32($i13, $i11);
  assume {:sourceloc "spectre.c", 136, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 137, 9} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "spectre.c", 135, 13} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "spectre.c", 138, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
}
const main: ref;
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 246, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i64.i8($i3);
