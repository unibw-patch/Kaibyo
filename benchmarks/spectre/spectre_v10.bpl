...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv10 -fms-extensions -I../../include/ -bpl spectre_v10.bpl
...
axiom (victim_function_v10 == $sub.ref(0, 15762));
procedure  victim_function_v10($i0: i64, $i1: i8)
{
  var $i2: i32;
  var $i3: i64;
  var $i4: i1;
...
$bb0:
  ...
  call {:cexpr "victim_function_v10:arg:x"} boogie_si_record_i64($i0);
  call {:cexpr "victim_function_v10:arg:k"} boogie_si_record_i8($i1);
  assume {:sourceloc "spectre.c", 131, 13} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 131, 13} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i32.i64($i2);
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i0, 1));
  assume {:sourceloc "spectre.c", 132, 13} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, $p5);
  assume {:sourceloc "spectre.c", 132, 13} true;
  assume {:verifier.code 0} true;
  $i7 := $zext.i8.i32($i6);
  assume {:sourceloc "spectre.c", 132, 26} true;
  assume {:verifier.code 0} true;
  $i8 := $zext.i8.i32($i1);
...
$bb4:
  ...
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, array2);
  assume {:sourceloc "spectre.c", 133, 21} true;
  assume {:verifier.code 0} true;
  $i11 := $zext.i8.i32($i10);
  assume {:sourceloc "spectre.c", 133, 18} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, temp);
  assume {:sourceloc "spectre.c", 133, 18} true;
  assume {:verifier.code 0} true;
  $i13 := $zext.i8.i32($i12);
  assume {:sourceloc "spectre.c", 133, 18} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:133:18: warning: over-approximating bitwise operation and;
  $i14 := $and.i32($i13, $i11);
  assume {:sourceloc "spectre.c", 133, 18} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 133, 18} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i15);
  call {:cexpr "temp"} boogie_si_record_i8($i15);
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i2);
  call {:cexpr "k"} boogie_si_record_i64($i3);
  assume {:sourceloc "spectre.c", 243, 27} true;
  assume {:verifier.code 0} true;
  $i4 := $trunc.i64.i8($i3);
  assume {:sourceloc "spectre.c", 243, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v10($i1, $i4);
