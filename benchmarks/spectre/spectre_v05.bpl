...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv05 -fms-extensions -I../../include/ -bpl spectre_v05.bpl
...
axiom (victim_function_v05 == $sub.ref(0, 15762));
procedure  victim_function_v05($i0: i64)
{
  var $i1: i32;
  var $i2: i64;
  var $i3: i1;
...
$bb0:
  ...
  call {:cexpr "victim_function_v05:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 71, 14} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i4 := $sub.i64($i0, 1);
  assume {:sourceloc "spectre.c", 72, 20} true;
  assume {:verifier.code 0} true;
  $i5 := $trunc.i64.i32($i4);
...
$bb5:
  ...
  assume {:sourceloc "spectre.c", 73, 31} true;
  assume {:verifier.code 0} true;
  $p9 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i8, 1));
  assume {:sourceloc "spectre.c", 73, 31} true;
  assume {:verifier.code 0} true;
  $i10 := $load.i8($M.0, $p9);
  assume {:sourceloc "spectre.c", 73, 31} true;
  ...
  assume {:sourceloc "spectre.c", 73, 24} true;
  assume {:verifier.code 0} true;
  $p14 := $add.ref($add.ref(array2, $mul.ref(0, 256)), $mul.ref($i13, 1));
  assume {:sourceloc "spectre.c", 73, 24} true;
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, $p14);
  assume {:sourceloc "spectre.c", 73, 24} true;
  ...
  assume {:sourceloc "spectre.c", 73, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i20);
  call {:cexpr "temp"} boogie_si_record_i8($i20);
