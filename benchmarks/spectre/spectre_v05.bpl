...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv05 -bpl spectre_v05.bpl
...
axiom (victim_function_v05 == $sub.ref(0, 12625));
...
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "spectre.c", 75, 22} true;
  assume {:verifier.code 0} true;
  $i4 := $sub.i64($i0, 1);
  assume {:sourceloc "spectre.c", 75, 20} true;
  assume {:verifier.code 0} true;
  $i5 := $trunc.i64.i32($i4);
  call {:cexpr "i"} boogie_si_record_i32($i5);
  assume {:sourceloc "spectre.c", 75, 16} true;
  assume {:verifier.code 0} true;
  $i6 := $i5;
  goto $bb4;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 78, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  $i11 := $zext.i8.i32($i10);
  assume {:sourceloc "spectre.c", 76, 41} true;
  assume {:verifier.code 0} true;
  $i12 := $mul.i32($i11, 1);
  ...
  assume {:sourceloc "spectre.c", 76, 16} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !(($i7 == 1));
  assume {:sourceloc "spectre.c", 77, 6} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume {:sourceloc "spectre.c", 75, 36} true;
  assume {:verifier.code 0} true;
