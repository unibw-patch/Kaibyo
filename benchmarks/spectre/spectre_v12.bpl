...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv12 -bpl spectre_v12.bpl
...
axiom (victim_function_v12 == $sub.ref(0, 12625));
procedure  victim_function_v12($i0: i64, $i1: i64)
{
  ...
  var $i18: i8;
$bb0:
  assume {:sourceloc "spectre.c", 170, 12} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $add.i64($i0, $i1);
  assume {:sourceloc "spectre.c", 170, 19} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 170, 19} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i32.i64($i3);
  assume {:sourceloc "spectre.c", 170, 17} true;
  assume {:verifier.code 0} true;
  $i5 := $ult.i64($i2, $i4);
  assume {:sourceloc "spectre.c", 170, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i5} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i5 == 1);
  assume {:sourceloc "spectre.c", 171, 33} true;
  assume {:verifier.code 0} true;
  $i6 := $add.i64($i0, $i1);
  assume {:sourceloc "spectre.c", 171, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $zext.i8.i32($i8);
  assume {:sourceloc "spectre.c", 171, 38} true;
  assume {:verifier.code 0} true;
  $i10 := $mul.i32($i9, 1);
  assume {:sourceloc "spectre.c", 171, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i14 := $zext.i8.i32($i13);
  assume {:sourceloc "spectre.c", 171, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 171, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:171:14: warning: over-approximating bitwise operation and;
  $i17 := $and.i32($i16, $i14);
  assume {:sourceloc "spectre.c", 171, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 172, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 170, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 173, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
