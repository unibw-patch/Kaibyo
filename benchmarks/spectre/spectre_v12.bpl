...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv12 -fms-extensions -I../../include/ -bpl spectre_v12.bpl
...
axiom (victim_function_v12 == $sub.ref(0, 15762));
procedure  victim_function_v12($i0: i64, $i1: i64)
{
  var $i2: i64;
  var $i3: i32;
  var $i4: i64;
...
$bb0:
  ...
  call {:cexpr "victim_function_v12:arg:x"} boogie_si_record_i64($i0);
  call {:cexpr "victim_function_v12:arg:y"} boogie_si_record_i64($i1);
  assume {:sourceloc "spectre.c", 167, 12} true;
  assume {:verifier.code 0} true;
  $i2 := $add.i64($i0, $i1);
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i6, 1));
  assume {:sourceloc "spectre.c", 168, 24} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, $p7);
  assume {:sourceloc "spectre.c", 168, 24} true;
  ...
  assume {:sourceloc "spectre.c", 168, 17} true;
  assume {:verifier.code 0} true;
  $p12 := $add.ref($add.ref(array2, $mul.ref(0, 256)), $mul.ref($i11, 1));
  assume {:sourceloc "spectre.c", 168, 17} true;
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, $p12);
  assume {:sourceloc "spectre.c", 168, 17} true;
  ...
  assume {:verifier.code 0} true;
  $i15 := $load.i8($M.0, temp);
  assume {:sourceloc "spectre.c", 168, 14} true;
  assume {:verifier.code 0} true;
  $i16 := $zext.i8.i32($i15);
  assume {:sourceloc "spectre.c", 168, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:168:14: warning: over-approximating bitwise operation and;
  $i17 := $and.i32($i16, $i14);
  assume {:sourceloc "spectre.c", 168, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 168, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i18);
  call {:cexpr "temp"} boogie_si_record_i8($i18);
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call victim_function_v12($i1, $i3);
