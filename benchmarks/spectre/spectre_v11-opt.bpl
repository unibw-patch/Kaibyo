...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv11 -fms-extensions -I../../include/ -bpl spectre_v11-opt.bpl
...
$bb1:
  ...
  assume {:sourceloc "spectre.c", 157, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i13);
  call {:cexpr "temp"} boogie_si_record_i8($i13);
