...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv06 -fms-extensions -I../../include/ -bpl spectre_v06.bpl
...
axiom (victim_function_v06 == $sub.ref(0, 15762));
procedure  victim_function_v06($i0: i64)
{
  var $i1: i8;
  var $i2: i64;
  var $i3: i64;
...
$bb0:
  ...
  call {:cexpr "victim_function_v06:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 84, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i8($M.0, array_size_mask);
  assume {:sourceloc "spectre.c", 84, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $zext.i8.i64($i1);
  assume {:sourceloc "spectre.c", 84, 12} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:84:12: warning: over-approximating bitwise operation and;
  $i3 := $and.i64($i0, $i2);
...
$bb1:
  ...
  assume {:sourceloc "spectre.c", 85, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:85:14: warning: over-approximating bitwise operation and;
  $i15 := $and.i32($i14, $i12);
  assume {:sourceloc "spectre.c", 85, 14} true;
  assume {:verifier.code 0} true;
