...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv06 -bpl spectre_v06.bpl
...
axiom (victim_function_v06 == $sub.ref(0, 12625));
procedure  victim_function_v06($i0: i64)
{
  ...
  var $i16: i8;
$bb0:
  assume {:sourceloc "spectre.c", 87, 14} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $zext.i8.i64($i1);
  assume {:sourceloc "spectre.c", 87, 12} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:87:12: warning: over-approximating bitwise operation and;
  $i3 := $and.i64($i0, $i2);
  assume {:sourceloc "spectre.c", 87, 31} true;
  assume {:verifier.code 0} true;
  $i4 := $eq.i64($i3, $i0);
  assume {:sourceloc "spectre.c", 87, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i4} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "spectre.c", 88, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $zext.i8.i32($i6);
  assume {:sourceloc "spectre.c", 88, 34} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.i32($i7, 1);
  assume {:sourceloc "spectre.c", 88, 17} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.i32.i64($i8);
  assume {:sourceloc "spectre.c", 88, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i12 := $zext.i8.i32($i11);
  assume {:sourceloc "spectre.c", 88, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 88, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:88:14: warning: over-approximating bitwise operation and;
  $i15 := $and.i32($i14, $i12);
  assume {:sourceloc "spectre.c", 88, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 89, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 87, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 90, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
