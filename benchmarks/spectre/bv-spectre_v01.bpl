...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv01 -fms-extensions -I../../include/ -bpl bv-spectre_v01.bpl --bit-precise
...
const victim_function_v01: ref;
axiom (victim_function_v01 == $sub.ref(0, 16580));
procedure  victim_function_v01($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv1;
  var $i3: bv64;
  ...
  var $i11: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 25, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v01:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 25, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 25, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 25, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "spectre.c", 26, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i5 := $load.bv32($M.0, $p4);
  assume {:sourceloc "spectre.c", 26, 34} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.bv32($i5, 1bv32);
  assume {:sourceloc "spectre.c", 26, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $load.bv32($M.0, $p8);
  assume {:sourceloc "spectre.c", 26, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 27, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 25, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 28, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 216, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v01($i0);
