...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv02 -fms-extensions -I../../include/ -bpl spectre_v02.bpl
...
axiom (leakByteLocalFunction == $sub.ref(0, 15762));
procedure  leakByteLocalFunction($i0: i8)
{
  var $i1: i32;
  var $i2: i32;
  var $i3: i64;
  ...
  var $i10: i8;
$bb0:
  assume {:sourceloc "spectre.c", 33, 56} true;
  assume {:verifier.code 0} true;
  call {:cexpr "leakByteLocalFunction:arg:k"} boogie_si_record_i8($i0);
  assume {:sourceloc "spectre.c", 33, 56} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i8.i32($i0);
  assume {:sourceloc "spectre.c", 33, 59} true;
  assume {:verifier.code 0} true;
  $i2 := $mul.i32($i1, 1);
  assume {:sourceloc "spectre.c", 33, 49} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i2);
  assume {:sourceloc "spectre.c", 33, 49} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $zext.i8.i32($i5);
  assume {:sourceloc "spectre.c", 33, 46} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, temp);
  assume {:sourceloc "spectre.c", 33, 46} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 33, 46} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:33:46: warning: over-approximating bitwise operation and;
  $i9 := $and.i32($i8, $i6);
  assume {:sourceloc "spectre.c", 33, 46} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i32.i8($i9);
  ...
  assume {:sourceloc "spectre.c", 33, 68} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const victim_function_v02: ref;
axiom (victim_function_v02 == $sub.ref(0, 16794));
procedure  victim_function_v02($i0: i64)
{
  var $i1: i32;
  var $i2: i64;
  var $i3: i1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v02:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 35, 13} true;
  assume {:verifier.code 0} true;
