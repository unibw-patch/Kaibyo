...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv02 -bpl spectre_v02.bpl
...
axiom (leakByteLocalFunction == $sub.ref(0, 12625));
procedure  leakByteLocalFunction($i0: i8)
{
  ...
  var $i10: i8;
$bb0:
  assume {:sourceloc "spectre.c", 36, 56} true;
  assume {:verifier.code 0} true;
  call {:cexpr "leakByteLocalFunction:arg:k"} boogie_si_record_i8($i0);
  assume {:sourceloc "spectre.c", 36, 56} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i8.i32($i0);
  assume {:sourceloc "spectre.c", 36, 59} true;
  assume {:verifier.code 0} true;
  $i2 := $mul.i32($i1, 1);
  assume {:sourceloc "spectre.c", 36, 49} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i2);
  assume {:sourceloc "spectre.c", 36, 49} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $zext.i8.i32($i5);
  assume {:sourceloc "spectre.c", 36, 46} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, temp);
  assume {:sourceloc "spectre.c", 36, 46} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 36, 46} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:36:46: warning: over-approximating bitwise operation and;
  $i9 := $and.i32($i8, $i6);
  assume {:sourceloc "spectre.c", 36, 46} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i32.i8($i9);
  ...
  assume {:sourceloc "spectre.c", 36, 68} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const victim_function_v02: ref;
axiom (victim_function_v02 == $sub.ref(0, 13657));
procedure  victim_function_v02($i0: i64)
{
  ...
  var $i5: i8;
$bb0:
  assume {:sourceloc "spectre.c", 38, 13} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $zext.i32.i64($i1);
  assume {:sourceloc "spectre.c", 38, 11} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.i64($i0, $i2);
  assume {:sourceloc "spectre.c", 38, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "spectre.c", 39, 31} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i0, 1));
  assume {:sourceloc "spectre.c", 39, 31} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, $p4);
  assume {:sourceloc "spectre.c", 39, 9} true;
  assume {:verifier.code 0} true;
  call leakByteLocalFunction($i5);
  assume {:sourceloc "spectre.c", 40, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 38, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 41, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
