...
do
    ...
    smack -t spectre-loop.c --no-memory-splitting --clang-options="-D"$flag" -fms-extensions -I../../include/" -bpl bpl/$flag-loop.o0.bpl --integer-encoding bit-vector
    smack -t spectre-loop.c --no-memory-splitting --clang-options="-O2 -D"$flag" -fms-extensions -I../../include/" -bpl bpl/$flag-loop.o2.bpl --integer-encoding bit-vector
done
