...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv03 -fms-extensions -I../../include/ -bpl bv-spectre_v03-opt.bpl --bit-precise
...
axiom (leakByteNoinlineFunction == $sub.ref(0, 17612));
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 46, 69} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref($bv2int.64($i1), 4));
  assume {:sourceloc "spectre.c", 46, 69} true;
  assume {:verifier.code 0} true;
  $i3 := $load.bv32($M.0, $p2);
  assume {:sourceloc "spectre.c", 46, 66} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, temp);
  assume {:sourceloc "spectre.c", 46, 66} true;
  assume {:verifier.code 0} true;
  $i5 := $and.bv32($i4, $i3);
  assume {:sourceloc "spectre.c", 46, 66} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, temp, $i5);
  call {:cexpr "temp"} boogie_si_record_bv32($i5);
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  call leakByteNoinlineFunction($i6);
