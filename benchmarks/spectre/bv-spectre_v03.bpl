...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv03 -fms-extensions -I../../include/ -bpl bv-spectre_v03.bpl --bit-precise
...
const leakByteNoinlineFunction: ref;
axiom (leakByteNoinlineFunction == $sub.ref(0, 16580));
procedure  leakByteNoinlineFunction($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv64;
  var $p3: ref;
  ...
  var $i6: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 46, 79} true;
  assume {:verifier.code 0} true;
  call {:cexpr "leakByteNoinlineFunction:arg:k"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 46, 79} true;
  assume {:verifier.code 0} true;
  $i1 := $mul.bv32($i0, 1bv32);
  assume {:sourceloc "spectre.c", 46, 69} true;
  assume {:verifier.code 0} true;
  $i2 := $sext.bv32.bv64($i1);
  assume {:sourceloc "spectre.c", 46, 69} true;
  assume {:verifier.code 0} true;
  $p3 := $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref($bv2int.64($i2), 4));
  assume {:sourceloc "spectre.c", 46, 69} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, $p3);
  assume {:sourceloc "spectre.c", 46, 66} true;
  assume {:verifier.code 0} true;
  $i5 := $load.bv32($M.0, temp);
  assume {:sourceloc "spectre.c", 46, 66} true;
  assume {:verifier.code 0} true;
  $i6 := $and.bv32($i5, $i4);
  assume {:sourceloc "spectre.c", 46, 66} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, temp, $i6);
  call {:cexpr "temp"} boogie_si_record_bv32($i6);
  assume {:sourceloc "spectre.c", 46, 88} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const victim_function_v03: ref;
axiom (victim_function_v03 == $sub.ref(0, 17612));
procedure  victim_function_v03($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv1;
  var $i3: bv64;
  ...
  var $i5: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 48, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v03:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 48, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 48, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 48, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "spectre.c", 49, 34} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i5 := $load.bv32($M.0, $p4);
  assume {:sourceloc "spectre.c", 49, 9} true;
  assume {:verifier.code 0} true;
  call leakByteNoinlineFunction($i5);
  assume {:sourceloc "spectre.c", 50, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 48, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 51, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 222, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v03($i0);
