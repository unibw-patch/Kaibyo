...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv04 -fms-extensions -I../../include/ -bpl bv-spectre_v04-opt.bpl --bit-precise
