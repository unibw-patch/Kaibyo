...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv03 -fms-extensions -I../../include/ -bpl spectre_v03.bpl
...
axiom (leakByteNoinlineFunction == $sub.ref(0, 15762));
procedure  leakByteNoinlineFunction($i0: i8)
{
  var $i1: i32;
  var $i2: i32;
  var $i3: i64;
  ...
  var $i10: i8;
$bb0:
  assume {:sourceloc "spectre.c", 46, 80} true;
  assume {:verifier.code 0} true;
  call {:cexpr "leakByteNoinlineFunction:arg:k"} boogie_si_record_i8($i0);
  assume {:sourceloc "spectre.c", 46, 80} true;
  assume {:verifier.code 0} true;
  $i1 := $zext.i8.i32($i0);
  assume {:sourceloc "spectre.c", 46, 83} true;
  assume {:verifier.code 0} true;
  $i2 := $mul.i32($i1, 1);
  assume {:sourceloc "spectre.c", 46, 73} true;
  assume {:verifier.code 0} true;
  $i3 := $sext.i32.i64($i2);
  assume {:sourceloc "spectre.c", 46, 73} true;
  assume {:verifier.code 0} true;
  $p4 := $add.ref($add.ref(array2, $mul.ref(0, 256)), $mul.ref($i3, 1));
  assume {:sourceloc "spectre.c", 46, 73} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i8($M.0, $p4);
  assume {:sourceloc "spectre.c", 46, 73} true;
  assume {:verifier.code 0} true;
  $i6 := $zext.i8.i32($i5);
  assume {:sourceloc "spectre.c", 46, 70} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, temp);
  assume {:sourceloc "spectre.c", 46, 70} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 46, 70} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:46:70: warning: over-approximating bitwise operation and;
  $i9 := $and.i32($i8, $i6);
  assume {:sourceloc "spectre.c", 46, 70} true;
  assume {:verifier.code 0} true;
  $i10 := $trunc.i32.i8($i9);
  assume {:sourceloc "spectre.c", 46, 70} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i10);
  call {:cexpr "temp"} boogie_si_record_i8($i10);
  assume {:sourceloc "spectre.c", 46, 92} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
const victim_function_v03: ref;
axiom (victim_function_v03 == $sub.ref(0, 16794));
procedure  victim_function_v03($i0: i64)
{
  var $i1: i32;
  var $i2: i64;
  var $i3: i1;
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v03:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 48, 13} true;
  assume {:verifier.code 0} true;
