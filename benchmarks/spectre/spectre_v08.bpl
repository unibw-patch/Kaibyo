...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv08 -fms-extensions -I../../include/ -bpl spectre_v08.bpl
...
axiom (victim_function_v08 == $sub.ref(0, 15762));
procedure  victim_function_v08($i0: i64)
{
  var $i1: i32;
  var $i2: i64;
  var $i3: i1;
...
$bb0:
  ...
  call {:cexpr "victim_function_v08:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 108, 30} true;
  assume {:verifier.code 0} true;
...
$bb3:
  ...
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i12);
  call {:cexpr "temp"} boogie_si_record_i8($i12);
