...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv08 -bpl spectre_v08.bpl
...
axiom (victim_function_v08 == $sub.ref(0, 12625));
procedure  victim_function_v08($i0: i64)
{
  ...
  var $i12: i8;
$bb0:
  assume {:sourceloc "spectre.c", 111, 30} true;
  ...
  assume {:verifier.code 0} true;
  $i2 := $zext.i32.i64($i1);
  assume {:sourceloc "spectre.c", 111, 28} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.i64($i0, $i2);
  assume {:sourceloc "spectre.c", 111, 26} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i3} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i3 == 1);
  assume {:sourceloc "spectre.c", 111, 47} true;
  assume {:verifier.code 0} true;
  $i4 := $add.i64($i0, 1);
  assume {:sourceloc "spectre.c", 111, 26} true;
  assume {:verifier.code 0} true;
...
$bb3:
  assume {:sourceloc "spectre.c", 111, 26} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 111, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $zext.i8.i32($i7);
  assume {:sourceloc "spectre.c", 111, 57} true;
  assume {:verifier.code 0} true;
  $i9 := $mul.i32($i8, 1);
  assume {:sourceloc "spectre.c", 111, 12} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.i32.i64($i9);
  assume {:sourceloc "spectre.c", 111, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, $p11);
  assume {:sourceloc "spectre.c", 111, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i12);
  call {:cexpr "temp"} boogie_si_record_i8($i12);
  assume {:sourceloc "spectre.c", 112, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
