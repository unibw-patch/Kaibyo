...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv13 -fms-extensions -I../../include/ -bpl bv-spectre_v13.bpl --bit-precise
...
const is_x_safe: ref;
axiom (is_x_safe == $sub.ref(0, 16580));
procedure  is_x_safe($i0: bv32)
  returns ($r: bv32)
{
  var $i1: bv32;
  var $i2: bv1;
  var $i3: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 178, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "is_x_safe:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 178, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 178, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 178, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "spectre.c", 179, 9} true;
  assume {:verifier.code 0} true;
  $i3 := 1bv32;
  goto $bb3;
$bb2:
  assume !(($i2 == 1bv1));
  assume {:sourceloc "spectre.c", 181, 5} true;
  assume {:verifier.code 0} true;
  $i3 := 0bv32;
  goto $bb3;
$bb3:
  ...
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 182, 1} true;
  assume {:verifier.code 0} true;
  $r := $i3;
  $exn := false;
  return;
}
const victim_function_v13: ref;
axiom (victim_function_v13 == $sub.ref(0, 17612));
procedure  victim_function_v13($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv1;
  var $i3: bv64;
  ...
  var $i11: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 184, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v13:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 184, 9} true;
  assume {:verifier.code 0} true;
  call $i1 := is_x_safe($i0);
  assume {:sourceloc "spectre.c", 184, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $ne.bv32($i1, 0bv32);
  assume {:sourceloc "spectre.c", 184, 9} true;
...
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "spectre.c", 185, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i5 := $load.bv32($M.0, $p4);
  assume {:sourceloc "spectre.c", 185, 34} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.bv32($i5, 1bv32);
  assume {:sourceloc "spectre.c", 185, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $load.bv32($M.0, $p8);
  assume {:sourceloc "spectre.c", 185, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 186, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 184, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 187, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 252, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v13($i0);
