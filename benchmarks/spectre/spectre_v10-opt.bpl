...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv10 -fms-extensions -I../../include/ -bpl spectre_v10-opt.bpl
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i6 := $trunc.i32.i8($i2);
  call {:cexpr "k"} boogie_si_record_i8($i6);
