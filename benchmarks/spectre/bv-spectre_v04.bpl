...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv04 -fms-extensions -I../../include/ -bpl bv-spectre_v04.bpl --bit-precise
...
const victim_function_v04: ref;
axiom (victim_function_v04 == $sub.ref(0, 16580));
procedure  victim_function_v04($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv1;
  var $i3: bv32;
  ...
  var $i12: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 59, 13} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v04:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 59, 13} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 59, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 59, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "spectre.c", 60, 33} true;
  assume {:verifier.code 0} true;
  $i3 := $shl.bv32($i0, 1bv32);
  assume {:sourceloc "spectre.c", 60, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $load.bv32($M.0, $p5);
  assume {:sourceloc "spectre.c", 60, 39} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.bv32($i6, 1bv32);
  assume {:sourceloc "spectre.c", 60, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 60, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 61, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 59, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 62, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 225, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v04($i0);
