...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv08 -fms-extensions -I../../include/ -bpl bv-spectre_v08-opt.bpl --bit-precise
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i4 := $add.bv32($i0, 1bv32);
  assume {:sourceloc "spectre.c", 108, 26} true;
  assume {:verifier.code 0} true;
  $i5 := (if ($i3 == 1bv1) then $i4 else 0bv32);
