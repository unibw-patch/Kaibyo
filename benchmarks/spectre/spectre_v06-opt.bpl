...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv06 -fms-extensions -I../../include/ -bpl spectre_v06-opt.bpl
...
$bb0:
  ...
  assume {:verifier.code 0} true;
  $i3 := $load.i8($M.0, array_size_mask);
  assume {:sourceloc "spectre.c", 84, 14} true;
  assume {:verifier.code 0} true;
  $i4 := $zext.i8.i64($i3);
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i1, 1));
  assume {:sourceloc "spectre.c", 85, 24} true;
  assume {:verifier.code 0} true;
  $i8 := $load.i8($M.0, $p7);
