...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv02 -fms-extensions -I../../include/ -bpl spectre_v02-opt.bpl
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, $p6);
  call {:cexpr "k"} boogie_si_record_i8($i7);
