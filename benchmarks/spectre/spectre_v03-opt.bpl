...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv03 -fms-extensions -I../../include/ -bpl spectre_v03-opt.bpl
...
axiom (leakByteNoinlineFunction == $sub.ref(0, 16794));
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 46, 73} true;
  assume {:verifier.code 0} true;
  $p2 := $add.ref($add.ref(array2, $mul.ref(0, 256)), $mul.ref($i1, 1));
  assume {:sourceloc "spectre.c", 46, 73} true;
  assume {:verifier.code 0} true;
  $i3 := $load.i8($M.0, $p2);
  ...
  assume {:sourceloc "spectre.c", 46, 70} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i5);
  call {:cexpr "temp"} boogie_si_record_i8($i5);
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i1, 1));
  assume {:sourceloc "spectre.c", 49, 34} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, $p6);
  assume {:sourceloc "spectre.c", 49, 9} true;
  assume {:verifier.code 0} true;
  call leakByteNoinlineFunction($i7);
