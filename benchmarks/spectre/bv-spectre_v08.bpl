...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv08 -fms-extensions -I../../include/ -bpl bv-spectre_v08.bpl --bit-precise
...
const victim_function_v08: ref;
axiom (victim_function_v08 == $sub.ref(0, 16580));
procedure  victim_function_v08($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv1;
  var $i3: bv32;
  ...
  var $i11: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 108, 30} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v08:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 108, 30} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 108, 28} true;
  assume {:verifier.code 0} true;
  $i2 := $ult.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 108, 26} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "spectre.c", 108, 47} true;
  assume {:verifier.code 0} true;
  $i3 := $add.bv32($i0, 1bv32);
  assume {:sourceloc "spectre.c", 108, 26} true;
  assume {:verifier.code 0} true;
  $i4 := $i3;
  goto $bb3;
...
$bb3:
  assume {:sourceloc "spectre.c", 108, 26} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 108, 19} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i7 := $load.bv32($M.0, $p6);
  assume {:sourceloc "spectre.c", 108, 57} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.bv32($i7, 1bv32);
  assume {:sourceloc "spectre.c", 108, 12} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 108, 10} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, temp, $i11);
  call {:cexpr "temp"} boogie_si_record_bv32($i11);
  assume {:sourceloc "spectre.c", 109, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 237, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v08($i0);
