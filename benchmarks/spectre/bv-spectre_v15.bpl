...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv15 -fms-extensions -I../../include/ -bpl bv-spectre_v15.bpl --bit-precise
...
const victim_function_v15: ref;
axiom (victim_function_v15 == $sub.ref(0, 16580));
procedure  victim_function_v15($p0: ref)
{
  var $i1: bv32;
  var $i2: bv32;
  var $i3: bv1;
  ...
  var $i13: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 206, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 206, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, $p0);
  assume {:sourceloc "spectre.c", 206, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $load.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 206, 12} true;
  assume {:verifier.code 0} true;
  $i3 := $ult.bv32($i1, $i2);
  assume {:sourceloc "spectre.c", 206, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "spectre.c", 207, 31} true;
  assume {:verifier.code 0} true;
  $i4 := $load.bv32($M.0, $p0);
  assume {:sourceloc "spectre.c", 207, 24} true;
  assume {:verifier.code 0} true;
  $i5 := $sext.bv32.bv64($i4);
  assume {:sourceloc "spectre.c", 207, 24} true;
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref($bv2int.64($i5), 4));
  assume {:sourceloc "spectre.c", 207, 24} true;
  assume {:verifier.code 0} true;
  $i7 := $load.bv32($M.0, $p6);
  assume {:sourceloc "spectre.c", 207, 35} true;
  assume {:verifier.code 0} true;
  $i8 := $mul.bv32($i7, 1bv32);
  assume {:sourceloc "spectre.c", 207, 17} true;
  assume {:verifier.code 0} true;
  $i9 := $sext.bv32.bv64($i8);
  assume {:sourceloc "spectre.c", 207, 17} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref($bv2int.64($i9), 4));
  assume {:sourceloc "spectre.c", 207, 17} true;
  assume {:verifier.code 0} true;
  $i11 := $load.bv32($M.0, $p10);
  assume {:sourceloc "spectre.c", 207, 14} true;
  assume {:verifier.code 0} true;
  $i12 := $load.bv32($M.0, temp);
  assume {:sourceloc "spectre.c", 207, 14} true;
  assume {:verifier.code 0} true;
  $i13 := $and.bv32($i12, $i11);
  assume {:sourceloc "spectre.c", 207, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, temp, $i13);
  call {:cexpr "temp"} boogie_si_record_bv32($i13);
  assume {:sourceloc "spectre.c", 208, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 206, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 209, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 258, 25} true;
  assume {:verifier.code 0} true;
  $i2 := $sext.bv32.bv64($i0);
  assume {:sourceloc "spectre.c", 258, 25} true;
  assume {:verifier.code 0} true;
  $p3 := $i2p.bv64.ref($i2);
  assume {:sourceloc "spectre.c", 258, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v15($p3);
