...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv15 -fms-extensions -I../../include/ -bpl spectre_v15.bpl
...
axiom (victim_function_v15 == $sub.ref(0, 15762));
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  $p6 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i5, 1));
  assume {:sourceloc "spectre.c", 207, 24} true;
  assume {:verifier.code 0} true;
  $i7 := $load.i8($M.0, $p6);
  assume {:sourceloc "spectre.c", 207, 24} true;
  ...
  assume {:sourceloc "spectre.c", 207, 17} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref(array2, $mul.ref(0, 256)), $mul.ref($i10, 1));
  assume {:sourceloc "spectre.c", 207, 17} true;
  assume {:verifier.code 0} true;
  $i12 := $load.i8($M.0, $p11);
  assume {:sourceloc "spectre.c", 207, 17} true;
  ...
  assume {:verifier.code 0} true;
  $i14 := $load.i8($M.0, temp);
  assume {:sourceloc "spectre.c", 207, 14} true;
  assume {:verifier.code 0} true;
  $i15 := $zext.i8.i32($i14);
  assume {:sourceloc "spectre.c", 207, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:207:14: warning: over-approximating bitwise operation and;
  $i16 := $and.i32($i15, $i13);
  assume {:sourceloc "spectre.c", 207, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 207, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i17);
  call {:cexpr "temp"} boogie_si_record_i8($i17);
