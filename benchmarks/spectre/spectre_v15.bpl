...
// via /usr/local/bin/smack -q -t spectre.c --no-memory-splitting --clang-options=-DCUSTOM_VERIFIER_ASSERT -O0 -fdeclspec -fno-vectorize -fno-slp-vectorize -I./include/ -Dv15 -bpl spectre_v15.bpl
...
axiom (victim_function_v15 == $sub.ref(0, 12625));
procedure  victim_function_v15($p0: ref)
{
  ...
  var $i17: i8;
$bb0:
  assume {:sourceloc "spectre.c", 209, 9} true;
  assume {:verifier.code 0} true;
  assume {:sourceloc "spectre.c", 209, 9} true;
  assume {:verifier.code 0} true;
  $i1 := $load.i64($M.0, $p0);
  assume {:sourceloc "spectre.c", 209, 14} true;
  assume {:verifier.code 0} true;
  $i2 := $load.i32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 209, 14} true;
  assume {:verifier.code 0} true;
  $i3 := $zext.i32.i64($i2);
  assume {:sourceloc "spectre.c", 209, 12} true;
  assume {:verifier.code 0} true;
  $i4 := $ult.i64($i1, $i3);
  assume {:sourceloc "spectre.c", 209, 9} true;
  assume {:verifier.code 0} true;
...
$bb1:
  assume ($i4 == 1);
  assume {:sourceloc "spectre.c", 210, 31} true;
  assume {:verifier.code 0} true;
  $i5 := $load.i64($M.0, $p0);
  assume {:sourceloc "spectre.c", 210, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i8 := $zext.i8.i32($i7);
  assume {:sourceloc "spectre.c", 210, 35} true;
  assume {:verifier.code 0} true;
  $i9 := $mul.i32($i8, 1);
  assume {:sourceloc "spectre.c", 210, 17} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.i32.i64($i9);
  assume {:sourceloc "spectre.c", 210, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $zext.i8.i32($i12);
  assume {:sourceloc "spectre.c", 210, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 210, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:210:14: warning: over-approximating bitwise operation and;
  $i16 := $and.i32($i15, $i13);
  assume {:sourceloc "spectre.c", 210, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 211, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 209, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 212, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 261, 25} true;
  assume {:verifier.code 0} true;
  $p3 := $i2p.i64.ref($i1);
  assume {:sourceloc "spectre.c", 261, 5} true;
  assume {:verifier.code 0} true;
