...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv12 -fms-extensions -I../../include/ -bpl bv-spectre_v12-opt.bpl --bit-precise
