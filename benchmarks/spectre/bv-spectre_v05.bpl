...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv05 -fms-extensions -I../../include/ -bpl bv-spectre_v05.bpl --bit-precise
...
axiom ($GLOBALS_BOTTOM == $sub.ref(0, 54764));
...
const victim_function_v05: ref;
axiom (victim_function_v05 == $sub.ref(0, 16580));
procedure  victim_function_v05($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv1;
  var $i3: bv32;
...
$bb0:
  ...
  call {:cexpr "victim_function_v05:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 71, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, array1_size);
...
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "spectre.c", 72, 22} true;
  assume {:verifier.code 0} true;
  $i3 := $sub.bv32($i0, 1bv32);
  call {:cexpr "i"} boogie_si_record_bv32($i3);
  assume {:sourceloc "spectre.c", 72, 16} true;
  assume {:verifier.code 0} true;
  $i4 := $i3;
  goto $bb4;
$bb2:
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 75, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
$bb4:
...
$bb5:
  ...
  assume {:verifier.code 0} true;
  $i6 := $sext.bv32.bv64($i4);
  assume {:sourceloc "spectre.c", 73, 31} true;
  assume {:verifier.code 0} true;
  $p7 := $add.ref($add.ref(array1, $mul.ref(0, 64)), $mul.ref($bv2int.64($i6), 4));
  assume {:sourceloc "spectre.c", 73, 31} true;
  assume {:verifier.code 0} true;
  $i8 := $load.bv32($M.0, $p7);
  assume {:sourceloc "spectre.c", 73, 41} true;
  assume {:verifier.code 0} true;
  $i9 := $mul.bv32($i8, 1bv32);
  assume {:sourceloc "spectre.c", 73, 24} true;
  assume {:verifier.code 0} true;
  $i10 := $sext.bv32.bv64($i9);
  assume {:sourceloc "spectre.c", 73, 24} true;
  assume {:verifier.code 0} true;
  $p11 := $add.ref($add.ref(array2, $mul.ref(0, 1024)), $mul.ref($bv2int.64($i10), 4));
  assume {:sourceloc "spectre.c", 73, 24} true;
  assume {:verifier.code 0} true;
  $i12 := $load.bv32($M.0, $p11);
  assume {:sourceloc "spectre.c", 73, 21} true;
  assume {:verifier.code 0} true;
  $i13 := $load.bv32($M.0, temp);
  assume {:sourceloc "spectre.c", 73, 21} true;
  assume {:verifier.code 0} true;
  $i14 := $and.bv32($i13, $i12);
  assume {:sourceloc "spectre.c", 73, 21} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, temp, $i14);
  call {:cexpr "temp"} boogie_si_record_bv32($i14);
  assume {:sourceloc "spectre.c", 73, 16} true;
  assume {:verifier.code 0} true;
  goto $bb7;
$bb6:
  assume !(($i5 == 1bv1));
  assume {:sourceloc "spectre.c", 74, 6} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb7:
  assume {:sourceloc "spectre.c", 72, 36} true;
  assume {:verifier.code 0} true;
  $i15 := $add.bv32($i4, $sub.bv32(0bv32, 1bv32));
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 228, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v05($i0);
...
axiom (llvm.dbg.value == $sub.ref(0, 53732));
procedure  llvm.dbg.value($p0: ref, $p1: ref, $p2: ref);
const __SMACK_static_init: ref;
axiom (__SMACK_static_init == $sub.ref(0, 54764));
