...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv14 -fms-extensions -I../../include/ -bpl spectre_v14.bpl
...
axiom (victim_function_v14 == $sub.ref(0, 15762));
procedure  victim_function_v14($i0: i64)
{
  var $i1: i32;
  var $i2: i64;
  var $i3: i1;
...
$bb0:
  ...
  call {:cexpr "victim_function_v14:arg:x"} boogie_si_record_i64($i0);
  assume {:sourceloc "spectre.c", 195, 13} true;
  assume {:verifier.code 0} true;
...
$bb1:
  ...
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:196:33: warning: over-approximating bitwise operation xor;
  $i4 := $xor.i64($i0, 255);
  assume {:sourceloc "spectre.c", 196, 24} true;
  assume {:verifier.code 0} true;
  $p5 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i4, 1));
  assume {:sourceloc "spectre.c", 196, 24} true;
  assume {:verifier.code 0} true;
  $i6 := $load.i8($M.0, $p5);
  assume {:sourceloc "spectre.c", 196, 24} true;
  ...
  assume {:sourceloc "spectre.c", 196, 17} true;
  assume {:verifier.code 0} true;
  $p10 := $add.ref($add.ref(array2, $mul.ref(0, 256)), $mul.ref($i9, 1));
  assume {:sourceloc "spectre.c", 196, 17} true;
  assume {:verifier.code 0} true;
  $i11 := $load.i8($M.0, $p10);
  assume {:sourceloc "spectre.c", 196, 17} true;
  ...
  assume {:verifier.code 0} true;
  $i13 := $load.i8($M.0, temp);
  assume {:sourceloc "spectre.c", 196, 14} true;
  assume {:verifier.code 0} true;
  $i14 := $zext.i8.i32($i13);
  assume {:sourceloc "spectre.c", 196, 14} true;
  assume {:verifier.code 0} true;
  // llvm2bpl: spectre.c:196:14: warning: over-approximating bitwise operation and;
  $i15 := $and.i32($i14, $i12);
  assume {:sourceloc "spectre.c", 196, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 196, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.i8($M.0, temp, $i16);
  call {:cexpr "temp"} boogie_si_record_i8($i16);
