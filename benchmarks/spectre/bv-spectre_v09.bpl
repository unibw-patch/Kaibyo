...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv09 -fms-extensions -I../../include/ -bpl bv-spectre_v09.bpl --bit-precise
...
const victim_function_v09: ref;
axiom (victim_function_v09 == $sub.ref(0, 16580));
procedure  victim_function_v09($i0: bv32, $p1: ref)
{
  var $i2: bv32;
  var $i3: bv1;
  var $i4: bv64;
  ...
  var $i12: bv32;
$bb0:
  assume {:sourceloc "spectre.c", 117, 9} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v09:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 117, 9} true;
  assume {:verifier.code 0} true;
  $i2 := $load.bv32($M.0, $p1);
  assume {:sourceloc "spectre.c", 117, 9} true;
...
$bb1:
  assume ($i3 == 1bv1);
  assume {:sourceloc "spectre.c", 118, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i6 := $load.bv32($M.0, $p5);
  assume {:sourceloc "spectre.c", 118, 34} true;
  assume {:verifier.code 0} true;
  $i7 := $mul.bv32($i6, 1bv32);
  assume {:sourceloc "spectre.c", 118, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 118, 14} true;
  assume {:verifier.code 0} true;
  ...
  assume {:sourceloc "spectre.c", 119, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 117, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 120, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 240, 27} true;
  assume {:verifier.code 0} true;
  $i2 := $sext.bv32.bv64($i1);
  assume {:sourceloc "spectre.c", 240, 27} true;
  assume {:verifier.code 0} true;
  $p3 := $i2p.bv64.ref($i2);
  assume {:sourceloc "spectre.c", 240, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v09($i0, $p3);
