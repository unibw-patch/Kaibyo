...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv09 -fms-extensions -I../../include/ -bpl bv-spectre_v09-opt.bpl --bit-precise
