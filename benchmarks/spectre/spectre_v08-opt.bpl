...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-O2 -Dv08 -fms-extensions -I../../include/ -bpl spectre_v08-opt.bpl
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 108, 26} true;
  assume {:verifier.code 0} true;
  $i7 := (if ($i5 == 1) then $i6 else 0);
  assume {:sourceloc "spectre.c", 108, 19} true;
  assume {:verifier.code 0} true;
  $p8 := $add.ref($add.ref(array1, $mul.ref(0, 16)), $mul.ref($i7, 1));
  assume {:sourceloc "spectre.c", 108, 19} true;
  assume {:verifier.code 0} true;
  $i9 := $load.i8($M.0, $p8);
