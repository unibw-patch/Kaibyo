...
// via /usr/local/bin/smack -t spectre.c --no-memory-splitting --clang-options=-Dv07 -fms-extensions -I../../include/ -bpl bv-spectre_v07.bpl --bit-precise
...
const victim_function_v07: ref;
axiom (victim_function_v07 == $sub.ref(0, 16580));
procedure  victim_function_v07($i0: bv32)
{
  var $i1: bv32;
  var $i2: bv1;
  var $i3: bv64;
  ...
  var $i13: bv1;
$bb0:
  assume {:sourceloc "spectre.c", 96, 14} true;
  assume {:verifier.code 0} true;
  call {:cexpr "victim_function_v07:arg:x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 96, 14} true;
  assume {:verifier.code 0} true;
  $i1 := $load.bv32($M.0, victim_function_v07.last_x);
  assume {:sourceloc "spectre.c", 96, 11} true;
  assume {:verifier.code 0} true;
  $i2 := $eq.bv32($i0, $i1);
  assume {:sourceloc "spectre.c", 96, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i2} true;
  goto $bb1, $bb2;
$bb1:
  assume ($i2 == 1bv1);
  assume {:sourceloc "spectre.c", 97, 24} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i5 := $load.bv32($M.0, $p4);
  assume {:sourceloc "spectre.c", 97, 34} true;
  assume {:verifier.code 0} true;
  $i6 := $mul.bv32($i5, 1bv32);
  assume {:sourceloc "spectre.c", 97, 17} true;
  assume {:verifier.code 0} true;
  ...
  assume {:verifier.code 0} true;
  $i9 := $load.bv32($M.0, $p8);
  assume {:sourceloc "spectre.c", 97, 14} true;
  assume {:verifier.code 0} true;
  $i10 := $load.bv32($M.0, temp);
  assume {:sourceloc "spectre.c", 97, 14} true;
  assume {:verifier.code 0} true;
  $i11 := $and.bv32($i10, $i9);
  assume {:sourceloc "spectre.c", 97, 14} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, temp, $i11);
  call {:cexpr "temp"} boogie_si_record_bv32($i11);
  assume {:sourceloc "spectre.c", 98, 5} true;
  assume {:verifier.code 0} true;
  goto $bb3;
$bb2:
  assume {:sourceloc "spectre.c", 96, 9} true;
  ...
  goto $bb3;
$bb3:
  assume {:sourceloc "spectre.c", 99, 13} true;
  assume {:verifier.code 0} true;
  $i12 := $load.bv32($M.0, array1_size);
  assume {:sourceloc "spectre.c", 99, 11} true;
  assume {:verifier.code 0} true;
  $i13 := $ult.bv32($i0, $i12);
  assume {:sourceloc "spectre.c", 99, 9} true;
  assume {:verifier.code 0} true;
  assume {:branchcond $i13} true;
  goto $bb4, $bb5;
$bb4:
  assume ($i13 == 1bv1);
  assume {:sourceloc "spectre.c", 100, 16} true;
  assume {:verifier.code 0} true;
  $M.0 := $store.bv32($M.0, victim_function_v07.last_x, $i0);
  call {:cexpr "victim_function_v07.last_x"} boogie_si_record_bv32($i0);
  assume {:sourceloc "spectre.c", 101, 5} true;
  assume {:verifier.code 0} true;
  goto $bb6;
$bb5:
  assume {:sourceloc "spectre.c", 99, 9} true;
  ...
  goto $bb6;
$bb6:
  assume {:sourceloc "spectre.c", 102, 1} true;
  assume {:verifier.code 0} true;
  $exn := false;
  return;
}
...
$bb0:
  ...
  assume {:sourceloc "spectre.c", 234, 5} true;
  assume {:verifier.code 0} true;
  call victim_function_v07($i0);
