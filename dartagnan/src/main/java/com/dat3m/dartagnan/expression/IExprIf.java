...
public class IExprIf extends IExpr implements ExprInterface {

	private BExpr guard;
	private IExpr tbranch;
	private IExpr fbranch;
	
	public IExprIf(BExpr guard, IExpr tbranch, IExpr fbranch) {
		this.guard =  guard;
